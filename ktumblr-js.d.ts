...
export declare namespace work.socialhub.ktumblr.api {
    interface BlogResource {
        ...
        postCreate(request: work.socialhub.ktumblr.api.request.blog.post.BlogPostRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        postEdit(request: work.socialhub.ktumblr.api.request.blog.post.BlogPostRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        postReblog(request: work.socialhub.ktumblr.api.request.blog.post.BlogReblogRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        postDelete(request: work.socialhub.ktumblr.api.request.blog.post.BlogDeleteRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        blogBanner(request: work.socialhub.ktumblr.api.request.blog.BlogBannerRequest): Promise<work.socialhub.ktumblr.api.response.Response<work.socialhub.ktumblr.api.response.Body<work.socialhub.ktumblr.api.response.blog.BlogBannerResponse>>>;
        blogUpdateInfo(request: work.socialhub.ktumblr.api.request.blog.BlogUpdateInfoRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        postEditTags(request: work.socialhub.ktumblr.api.request.blog.post.BlogPostEditTagsRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        postUpdate(request: work.socialhub.ktumblr.api.request.blog.post.BlogPostUpdateRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        readonly __doNotUseOrImplementIt: {
...
export declare namespace work.socialhub.ktumblr.api {
    interface UserResource {
        ...
        like(request: work.socialhub.ktumblr.api.request.user.UserLikeRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        unlike(request: work.socialhub.ktumblr.api.request.user.UserUnlikeRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        follow(request: work.socialhub.ktumblr.api.request.user.UserFollowRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        unfollow(request: work.socialhub.ktumblr.api.request.user.UserUnfollowRequest): Promise<work.socialhub.ktumblr.api.response.ResponseUnit>;
        readonly __doNotUseOrImplementIt: {
...
export declare namespace work.socialhub.ktumblr.api.request.blog {
    ...
    namespace BlogBannerRequest {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => BlogBannerRequest;
        }
    }
}
export declare namespace work.socialhub.ktumblr.api.request.blog {
...
export declare namespace work.socialhub.ktumblr.api.request.blog {
    class BlogUpdateInfoRequest /* implements work.socialhub.ktumblr.api.request.MapRequest */ {
        constructor();
        get blogName(): Nullable<string>;
        set blogName(value: Nullable<string>);
        ...
        get ask(): Nullable<string>;
        set ask(value: Nullable<string>);
        get submit(): Nullable<string>;
        set submit(value: Nullable<string>);
        get isDescriptionIndexable(): Nullable<boolean>;
        set isDescriptionIndexable(value: Nullable<boolean>);
        get isIndexFollowed(): Nullable<boolean>;
        set isIndexFollowed(value: Nullable<boolean>);
    }
    namespace BlogUpdateInfoRequest {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => BlogUpdateInfoRequest;
        }
    }
}
...
export declare namespace work.socialhub.ktumblr.api.request.blog.post {
    class BlogPostEditTagsRequest /* implements work.socialhub.ktumblr.api.request.MapRequest */ {
        constructor();
        get blogName(): Nullable<string>;
        set blogName(value: Nullable<string>);
        get id(): Nullable<string>;
    ...
    namespace BlogPostEditTagsRequest {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => BlogPostEditTagsRequest;
        }
    }
}
export declare namespace work.socialhub.ktumblr.api.request.blog.post {
...
export declare namespace work.socialhub.ktumblr.api.request.blog.post {
    class BlogPostUpdateRequest /* implements work.socialhub.ktumblr.api.request.MapRequest */ {
        constructor();
        get blogName(): Nullable<string>;
        set blogName(value: Nullable<string>);
        get id(): Nullable<string>;
        ...
        set startDate(value: Nullable<string>);
        get tzAddress(): Nullable<string>;
        set tzAddress(value: Nullable<string>);
        get replyKey(): Nullable<string>;
        set replyKey(value: Nullable<string>);
        get tags(): Nullable<Array<string>>;
        set tags(value: Nullable<Array<string>>);
        get data(): Nullable<Array<work.socialhub.ktumblr.api.request.FileRequest>>;
        set data(value: Nullable<Array<work.socialhub.ktumblr.api.request.FileRequest>>);
        ...
        get link(): Nullable<string>;
        set link(value: Nullable<string>);
        get quoteText(): Nullable<string>;
        set quoteText(value: Nullable<string>);
        get quoteSource(): Nullable<string>;
        set quoteSource(value: Nullable<string>);
        get linkUrl(): Nullable<string>;
        set linkUrl(value: Nullable<string>);
        get linkTitle(): Nullable<string>;
        set linkTitle(value: Nullable<string>);
        get linkDescription(): Nullable<string>;
        set linkDescription(value: Nullable<string>);
        get chatTitle(): Nullable<string>;
        set chatTitle(value: Nullable<string>);
        get chatLabel(): Nullable<string>;
        set chatLabel(value: Nullable<string>);
        get chatDialogue(): Nullable<string>;
        set chatDialogue(value: Nullable<string>);
        get externalUrl(): Nullable<string>;
        set externalUrl(value: Nullable<string>);
        get embed(): Nullable<string>;
        set embed(value: Nullable<string>);
        get answer(): Nullable<string>;
        set answer(value: Nullable<string>);
        toFileMap(): kotlin.collections.KtMap<string, kotlin.Pair<string, Int8Array>>;
    }
    namespace BlogPostUpdateRequest {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => BlogPostUpdateRequest;
        }
    }
}
export declare namespace work.socialhub.ktumblr.api.request.blog.post {
...
export declare namespace work.socialhub.ktumblr.api.response {
    class Response<T> {
        ...
        copy(data?: T, json?: string, status?: Nullable<number>, message?: Nullable<string>): work.socialhub.ktumblr.api.response.Response<T>;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
...
export declare namespace work.socialhub.ktumblr.api.response.blog {
    ...
    namespace BlogBannerResponse {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => BlogBannerResponse;
        }
    }
}
export declare namespace work.socialhub.ktumblr.api.response.blog {
...
export declare namespace work.socialhub.ktumblr.api.response.blog {
    ...
    namespace BlogUpdatedInfoResponse {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => BlogUpdatedInfoResponse;
        }
    }
}
...
export declare namespace work.socialhub.ktumblr.define {
    abstract class PhotoType {
        ...
        static values(): [typeof work.socialhub.ktumblr.define.PhotoType.SOURCE, typeof work.socialhub.ktumblr.define.PhotoType.FILE];
...
export declare namespace work.socialhub.ktumblr.define {
    abstract class PostType {
        ...
        static values(): [typeof work.socialhub.ktumblr.define.PostType.TEXT, typeof work.socialhub.ktumblr.define.PostType.PHOTO, typeof work.socialhub.ktumblr.define.PostType.QUOTE, typeof work.socialhub.ktumblr.define.PostType.LINK, typeof work.socialhub.ktumblr.define.PostType.CHAT, typeof work.socialhub.ktumblr.define.PostType.AUDIO, typeof work.socialhub.ktumblr.define.PostType.VIDEO, typeof work.socialhub.ktumblr.define.PostType.ANSWER, typeof work.socialhub.ktumblr.define.PostType.POSTCARD, typeof work.socialhub.ktumblr.define.PostType.UNKNOWN];
...
export declare namespace work.socialhub.ktumblr.entity.post {
    abstract class Post {
        ...
        get asLegacyAudioPost(): Nullable<work.socialhub.ktumblr.entity.post.legacy.LegacyAudioPost>;
        get asLegacyChatPost(): Nullable<work.socialhub.ktumblr.entity.post.legacy.LegacyChatPost>;
        get asLegacyAnswerPost(): Nullable<work.socialhub.ktumblr.entity.post.legacy.LegacyAnswerPost>;
        get asLegacyPostcardPost(): Nullable<work.socialhub.ktumblr.entity.post.legacy.LegacyPostcardPost>;
...
export declare namespace work.socialhub.ktumblr.entity.post.legacy {
    class LegacyPostcardPost extends work.socialhub.ktumblr.entity.post.Post.$metadata$.constructor {
        constructor(blogName: Nullable<string>, idString: Nullable<string>, genesisPostId: Nullable<string>, postUrl: Nullable<string>, parentPostUrl: Nullable<string>, type: Nullable<string>, timestamp: Nullable<number>, date: Nullable<string>, format: Nullable<string>, reblogKey: Nullable<string>, tags: Nullable<Array<string>>, isBookmarklet: Nullable<boolean>, isMobile: Nullable<boolean>, sourceUrl: Nullable<string>, sourceTitle: Nullable<string>, isLiked: Nullable<boolean>, state: Nullable<string>, title: Nullable<string>, body: Nullable<string>, noteCount: Nullable<number>, summary: Nullable<string>, slug: Nullable<string>, rebloggedFromId: Nullable<string>, rebloggedFromUrl: Nullable<string>, rebloggedFromName: Nullable<string>, rebloggedFromTitle: Nullable<string>, rebloggedFromUuid: Nullable<string>, rebloggedFromCanMessage: Nullable<boolean>, rebloggedFromFollowing: Nullable<boolean>, rebloggedRootId: Nullable<string>, rebloggedRootUrl: Nullable<string>, rebloggedRootName: Nullable<string>, rebloggedRootTitle: Nullable<string>, rebloggedRootUuid: Nullable<string>, rebloggedRootCanMessage: Nullable<boolean>, rebloggedRootFollowing: Nullable<boolean>, notes: Nullable<Array<work.socialhub.ktumblr.entity.Note>>, blog: Nullable<work.socialhub.ktumblr.entity.blog.Blog>, reblog: Nullable<work.socialhub.ktumblr.entity.blog.Reblog>, trail: Nullable<Array<work.socialhub.ktumblr.entity.trail.Trail>>);
        get blogName(): Nullable<string>;
        set blogName(value: Nullable<string>);
        get idString(): Nullable<string>;
    ...
    namespace LegacyPostcardPost {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => LegacyPostcardPost;
        }
    }
}
export declare namespace work.socialhub.ktumblr.entity.post.legacy {
