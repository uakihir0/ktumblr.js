(function (factory) {
  ...
  var compare = kotlin_kotlin.$_$.lb;
  ...
  var fromInt = kotlin_kotlin.$_$.rb;
  var modulo = kotlin_kotlin.$_$.vb;
  var divide = kotlin_kotlin.$_$.pb;
  var equalsLong = kotlin_kotlin.$_$.qb;
  var Companion_getInstance = kotlin_kotlin.$_$.t;
  var DurationUnit_NANOSECONDS_getInstance = kotlin_kotlin.$_$.f1;
  var toDuration = kotlin_kotlin.$_$.ci;
  var convertToInt = kotlin_kotlin.$_$.nb;
  var shiftRight = kotlin_kotlin.$_$.bc;
  ...
  var THROW_IAE = kotlin_kotlin.$_$.zi;
  var enumEntries = kotlin_kotlin.$_$.db;
  var Enum = kotlin_kotlin.$_$.oi;
  var System_getInstance = kotlin_kotlin.$_$.s;
  var initMetadataForObject = kotlin_kotlin.$_$.dd;
  var initMetadataForInterface = kotlin_kotlin.$_$.bd;
  var Companion_getInstance_0 = kotlin_kotlin.$_$.u;
  var IllegalArgumentException_init_$Init$ = kotlin_kotlin.$_$.s2;
  var objectCreate = kotlin_kotlin.$_$.yd;
  var captureStack = kotlin_kotlin.$_$.ic;
  var IllegalArgumentException_init_$Init$_0 = kotlin_kotlin.$_$.u2;
  var IllegalArgumentException_init_$Init$_1 = kotlin_kotlin.$_$.r2;
  var IllegalArgumentException_init_$Init$_2 = kotlin_kotlin.$_$.w2;
  var IllegalArgumentException = kotlin_kotlin.$_$.ri;
  var RuntimeException_init_$Init$ = kotlin_kotlin.$_$.j3;
  var RuntimeException_init_$Init$_0 = kotlin_kotlin.$_$.k3;
  var RuntimeException_init_$Init$_1 = kotlin_kotlin.$_$.i3;
  var RuntimeException_init_$Init$_2 = kotlin_kotlin.$_$.l3;
  var RuntimeException = kotlin_kotlin.$_$.xi;
  var negate = kotlin_kotlin.$_$.xb;
  var IllegalStateException_init_$Create$ = kotlin_kotlin.$_$.a3;
  var THROW_CCE = kotlin_kotlin.$_$.yi;
  var ClosedRange = kotlin_kotlin.$_$.ge;
  var OpenEndRange = kotlin_kotlin.$_$.he;
  var Companion_getInstance_1 = kotlin_kotlin.$_$.p;
  ...
  var multiply = kotlin_kotlin.$_$.wb;
  var add = kotlin_kotlin.$_$.hb;
  var get_ONE = kotlin_kotlin.$_$.gb;
  var subtract = kotlin_kotlin.$_$.cc;
  var bitwiseXor = kotlin_kotlin.$_$.kb;
  var numberRangeToNumber = kotlin_kotlin.$_$.wd;
  var contains = kotlin_kotlin.$_$.le;
  var bitwiseOr = kotlin_kotlin.$_$.jb;
  var bitwiseAnd = kotlin_kotlin.$_$.ib;
  var ArithmeticException = kotlin_kotlin.$_$.gi;
  var getStringHashCode = kotlin_kotlin.$_$.vc;
  var _Char___init__impl__6a9atx = kotlin_kotlin.$_$.y3;
  var KMutableProperty0 = kotlin_kotlin.$_$.ve;
  var getPropertyCallableRef = kotlin_kotlin.$_$.uc;
  var ensureNotNull = kotlin_kotlin.$_$.qj;
  var KMutableProperty1 = kotlin_kotlin.$_$.we;
  var listOf = kotlin_kotlin.$_$.t8;
  var emptyList = kotlin_kotlin.$_$.x7;
  var KProperty0 = kotlin_kotlin.$_$.xe;
  var noWhenBranchMatchedException = kotlin_kotlin.$_$.xj;
  var StringBuilder_init_$Create$ = kotlin_kotlin.$_$.i2;
  var to = kotlin_kotlin.$_$.ck;
  var listOf_0 = kotlin_kotlin.$_$.u8;
  var lazy = kotlin_kotlin.$_$.wj;
  var equals = kotlin_kotlin.$_$.rc;
  var last = kotlin_kotlin.$_$.s8;
  var charSequenceLength = kotlin_kotlin.$_$.nc;
  var prependIndent = kotlin_kotlin.$_$.ng;
  var charCodeAt = kotlin_kotlin.$_$.lc;
  var toString_0 = kotlin_kotlin.$_$.f4;
  var isArray = kotlin_kotlin.$_$.ed;
  var ArrayList_init_$Create$ = kotlin_kotlin.$_$.m1;
  var hashCode = kotlin_kotlin.$_$.wc;
  var get_indices = kotlin_kotlin.$_$.l8;
  var joinToString = kotlin_kotlin.$_$.m8;
  var padStart = kotlin_kotlin.$_$.mg;
  var mapOf = kotlin_kotlin.$_$.w8;
  var Char__rangeTo_impl_tkncvp = kotlin_kotlin.$_$.d4;
  var plus = kotlin_kotlin.$_$.z8;
  var Char = kotlin_kotlin.$_$.ji;
  var plus_0 = kotlin_kotlin.$_$.a9;
  var abs = kotlin_kotlin.$_$.de;
  var getBooleanHashCode = kotlin_kotlin.$_$.tc;
  var ArrayList_init_$Create$_0 = kotlin_kotlin.$_$.n1;
  var getOrNull = kotlin_kotlin.$_$.g8;
  var toString_1 = kotlin_kotlin.$_$.bk;
  var collectionSizeOrDefault = kotlin_kotlin.$_$.d7;
  var mapCapacity = kotlin_kotlin.$_$.v8;
  var coerceAtLeast = kotlin_kotlin.$_$.ie;
  var LinkedHashMap_init_$Create$ = kotlin_kotlin.$_$.v1;
  var substring = kotlin_kotlin.$_$.hh;
  var substring_0 = kotlin_kotlin.$_$.gh;
  var get_lastIndex = kotlin_kotlin.$_$.ig;
  var toSet = kotlin_kotlin.$_$.w9;
  var distinct = kotlin_kotlin.$_$.u7;
  var single = kotlin_kotlin.$_$.j9;
  var repeat = kotlin_kotlin.$_$.qg;
  var append = kotlin_kotlin.$_$.kf;
  var charSequenceSubSequence = kotlin_kotlin.$_$.oc;
  var charSequenceGet = kotlin_kotlin.$_$.mc;
  var mutableListOf = kotlin_kotlin.$_$.x8;
  var removeLastOrNull = kotlin_kotlin.$_$.d9;
  var sortWith = kotlin_kotlin.$_$.k9;
  var FunctionAdapter = kotlin_kotlin.$_$.ec;
  var Comparator = kotlin_kotlin.$_$.li;
  var compareValues = kotlin_kotlin.$_$.ca;
  var Exception = kotlin_kotlin.$_$.qi;
  var Exception_init_$Init$ = kotlin_kotlin.$_$.o2;
  var asReversed = kotlin_kotlin.$_$.w6;
  var StringBuilder_init_$Create$_0 = kotlin_kotlin.$_$.h2;
  var joinTo = kotlin_kotlin.$_$.o8;
  var firstOrNull = kotlin_kotlin.$_$.d8;
  var get_lastIndex_0 = kotlin_kotlin.$_$.q8;
  var toMutableList = kotlin_kotlin.$_$.v9;
  var addAll = kotlin_kotlin.$_$.q6;
  var asReversed_0 = kotlin_kotlin.$_$.v6;
  var sortedWith = kotlin_kotlin.$_$.l9;
  var binarySearch = kotlin_kotlin.$_$.a7;
  var startsWith = kotlin_kotlin.$_$.ah;
  var checkCountOverflow = kotlin_kotlin.$_$.b7;
  var until = kotlin_kotlin.$_$.ne;
  var getOrNull_0 = kotlin_kotlin.$_$.zf;
  var compareTo = kotlin_kotlin.$_$.pc;
  var removePrefix = kotlin_kotlin.$_$.og;
  var UnsupportedOperationException_init_$Create$ = kotlin_kotlin.$_$.p3;
  var Comparable = kotlin_kotlin.$_$.ki;
  var longRangeToLong = kotlin_kotlin.$_$.td;
  var Char__minus_impl_a2frrh = kotlin_kotlin.$_$.a4;
  var buildClassSerialDescriptor = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.g1;
  var getKClass = kotlin_kotlin.$_$.se;
  var arrayOf = kotlin_kotlin.$_$.mj;
  var createKType = kotlin_kotlin.$_$.qe;
  ...
  var LazyThreadSafetyMode_PUBLICATION_getInstance = kotlin_kotlin.$_$.i1;
  var lazy_0 = kotlin_kotlin.$_$.vj;
  var KProperty1 = kotlin_kotlin.$_$.ye;
  var MissingFieldException_init_$Create$ = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.m;
  ...
  var PrimitiveClasses_getInstance = kotlin_kotlin.$_$.q;
  var SerializationException_init_$Create$ = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.o;
  ...
  var charArrayOf = kotlin_kotlin.$_$.jc;
  var split = kotlin_kotlin.$_$.vg;
  var startsWith_0 = kotlin_kotlin.$_$.yg;
  var Companion_getInstance_2 = kotlin_kotlin.$_$.y;
  var LinkedHashMap_init_$Create$_0 = kotlin_kotlin.$_$.w1;
  var take = kotlin_kotlin.$_$.m9;
  var _Result___init__impl__xyqfz8 = kotlin_kotlin.$_$.g4;
  var createFailure = kotlin_kotlin.$_$.pj;
  var _Duration___get_inWholeSeconds__impl__hpy7b3 = kotlin_kotlin.$_$.s3;
  var _Duration___get_nanosecondsComponent__impl__nh19kq = kotlin_kotlin.$_$.u3;
  var Duration__isPositive_impl_tvkkt2 = kotlin_kotlin.$_$.t3;
  var Duration__unaryMinus_impl_x2k1y0 = kotlin_kotlin.$_$.x3;
  var DurationUnit_SECONDS_getInstance = kotlin_kotlin.$_$.g1;
  var toDuration_0 = kotlin_kotlin.$_$.di;
  var Duration__plus_impl_yu9v8f = kotlin_kotlin.$_$.v3;
  var shiftRightUnsigned = kotlin_kotlin.$_$.ac;
  var compareValuesBy = kotlin_kotlin.$_$.ba;
  var lastOrNull = kotlin_kotlin.$_$.r8;
  var binarySearch_0 = kotlin_kotlin.$_$.z6;
  var first = kotlin_kotlin.$_$.e8;
  var ArithmeticException_init_$Create$ = kotlin_kotlin.$_$.j2;
  ...
  initMetadataForClass(LocalDateRange, 'LocalDateRange', VOID, LocalDateProgression, [ClosedRange, OpenEndRange]);
  ...
  initMetadataForClass(YearMonthRange, 'YearMonthRange', VOID, YearMonthProgression, [ClosedRange, OpenEndRange]);
  ...
  function yearMonth(format) {
    return this.addFormatStructureForYearMonth_t4rp63_k$((format instanceof YearMonthFormat ? format : THROW_CCE()).actualFormat_1);
  }
  ...
  function date(format) {
    return this.addFormatStructureForDate_t2v9hh_k$((format instanceof LocalDateFormat ? format : THROW_CCE()).actualFormat_1);
  }
  ...
  function time(format) {
    return this.addFormatStructureForTime_h3r7lv_k$((format instanceof LocalTimeFormat ? format : THROW_CCE()).actualFormat_1);
  }
  ...
  function dateTime(format) {
    return this.addFormatStructureForDateTime_noiy5b_k$((format instanceof LocalDateTimeFormat ? format : THROW_CCE()).actualFormat_1);
  }
  ...
  function offset(format) {
    return this.addFormatStructureForOffset_puuf83_k$((format instanceof UtcOffsetFormat ? format : THROW_CCE()).actualFormat_1);
  }
  ...
  function toDeprecatedInstant(_this__u8e3s4) {
    return Companion_getInstance_31().fromEpochSeconds_idu11y_k$(_this__u8e3s4.get_epochSeconds_w76ght_k$(), _this__u8e3s4.get_nanosecondsOfSecond_n2ey8j_k$());
  }
  function format(_this__u8e3s4, format, offset) {
    offset = offset === VOID ? Companion_getInstance_35().get_ZERO_wodlgx_k$() : offset;
  ...
  function Companion_6() {
    ...
    this.serialVersionUID_1 = new Long(-367331340, 985152264);
  }
  ...
  function Companion_7() {
    ...
    this.serialVersionUID_1 = new Long(-1606983967, 269924282);
  }
  ...
  function Companion_8() {
    ...
    this.serialVersionUID_1 = new Long(-1408802782, -746875576);
  }
  ...
  function Companion_9() {
    ...
    this.EMPTY_1 = new LocalDateRange(LocalDate_init_$Create$(1970, 1, 2), LocalDate_init_$Create$(1970, 1, 1));
  }
  protoOf(Companion_9).get_EMPTY_i8q41w_k$ = function () {
    return this.EMPTY_1;
  };
  protoOf(Companion_9).fromRangeUntil_qv8t66_k$ = function (start, endExclusive) {
    return endExclusive.equals(Companion_getInstance_32().get_MIN_za2zu4_k$()) ? this.EMPTY_1 : this.fromRangeTo_amidtb_k$(start, minus(endExclusive, 1, Companion_getInstance_7().get_DAY_18jw19_k$()));
  };
  protoOf(Companion_9).fromRangeTo_amidtb_k$ = function (start, endInclusive) {
  ...
  protoOf(LocalDateRange).get_endExclusive_pmwm6k_k$ = function () {
    if (this.last_1.equals(Companion_getInstance_32().get_MAX_ieaqrm_k$())) {
  ...
  protoOf(Companion_10).fromClosedRange_dba2er_k$ = function (rangeStart, rangeEnd, stepValue, stepUnit) {
  ...
  function LocalDateProgression(longProgression) {
    ...
    this.first_1 = Companion_getInstance_32().fromEpochDays_4kf494_k$(this.longProgression_1.get_first_irdx8n_k$());
    this.last_1 = Companion_getInstance_32().fromEpochDays_4kf494_k$(this.longProgression_1.get_last_wopotb_k$());
  }
  ...
  protoOf(LocalDateProgressionIterator).next_20eer_k$ = function () {
    return Companion_getInstance_32().fromEpochDays_4kf494_k$(this.iterator_1.next_20eer_k$());
  };
  ...
  function onDay(_this__u8e3s4, day) {
    return LocalDate_init_$Create$_0(_this__u8e3s4.get_year_woy26e_k$(), _this__u8e3s4.get_month_ivc8d3_k$(), day);
  }
  function get_MAX(_this__u8e3s4) {
    return get_yearMonth(Companion_getInstance_32().get_MAX_ieaqrm_k$());
  }
  function plus_2(_this__u8e3s4, value, unit) {
    return plus_3(_this__u8e3s4, fromInt(value), unit);
  }
  function get_MIN(_this__u8e3s4) {
    return get_yearMonth(Companion_getInstance_32().get_MIN_za2zu4_k$());
  }
  ...
  function fromProlepticMonth(_this__u8e3s4, prolepticMonth) {
    ...
    var this_0 = numberRangeToNumber(Companion_getInstance_32().get_MIN_za2zu4_k$().get_year_woy26e_k$(), Companion_getInstance_32().get_MAX_ieaqrm_k$().get_year_woy26e_k$());
    // Inline function 'kotlin.require' call
    if (!contains(isInterface(this_0, ClosedRange) ? this_0 : THROW_CCE(), year)) {
      var message = 'Year ' + year.toString() + ' is out of range: ' + Companion_getInstance_32().get_MIN_za2zu4_k$().get_year_woy26e_k$() + '..' + Companion_getInstance_32().get_MAX_ieaqrm_k$().get_year_woy26e_k$();
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    ...
    var tmp$ret$6 = add(r, bitwiseAnd(other_0, shiftRight(bitwiseAnd(bitwiseXor(r, other_0), bitwiseOr(r, negate(r))), 63)));
    var month = convertToInt(tmp$ret$6) + 1 | 0;
    return YearMonth_init_$Create$(convertToInt(year), month);
  }
  function get_yearMonth(_this__u8e3s4) {
    return YearMonth_init_$Create$_0(_this__u8e3s4.get_year_woy26e_k$(), _this__u8e3s4.get_month_ivc8d3_k$());
  }
  function plus_3(_this__u8e3s4, value, unit) {
    ...
    try {
      ...
      if (equalsLong(monthsToAdd, new Long(0, 0))) {
        ...
        tmp_0 = fromProlepticMonth(Companion_getInstance_36(), safeAdd(get_prolepticMonth(_this__u8e3s4), monthsToAdd));
      }
      tmp = tmp_0;
    } catch ($p) {
      var tmp_1;
  ...
  function Companion_11() {
    ...
    this.EMPTY_1 = new YearMonthRange(YearMonth_init_$Create$(0, 2), YearMonth_init_$Create$(0, 1));
  }
  protoOf(Companion_11).get_EMPTY_i8q41w_k$ = function () {
    return this.EMPTY_1;
  };
  protoOf(Companion_11).fromRangeUntil_bi3wdq_k$ = function (start, endExclusive) {
    return endExclusive.equals(get_MIN(Companion_getInstance_36())) ? this.EMPTY_1 : this.fromRangeTo_pznalr_k$(start, minus_0(endExclusive, 1, Companion_getInstance_7().get_MONTH_id5p9z_k$()));
  };
  protoOf(Companion_11).fromRangeTo_pznalr_k$ = function (start, endInclusive) {
  ...
  protoOf(YearMonthRange).get_endExclusive_pmwm6k_k$ = function () {
    if (this.last_1.equals(get_MAX(Companion_getInstance_36()))) {
      // Inline function 'kotlin.error' call
  ...
  protoOf(Companion_12).fromClosedRange_aja6dr_k$ = function (rangeStart, rangeEnd, stepValue, stepUnit) {
  ...
  function YearMonthProgression(longProgression) {
    ...
    this.longProgression_1 = longProgression;
    this.first_1 = fromProlepticMonth(Companion_getInstance_36(), this.longProgression_1.get_first_irdx8n_k$());
    this.last_1 = fromProlepticMonth(Companion_getInstance_36(), this.longProgression_1.get_last_wopotb_k$());
  }
  ...
  protoOf(YearMonthProgressionIterator).next_20eer_k$ = function () {
    return fromProlepticMonth(Companion_getInstance_36(), this.iterator_1.next_20eer_k$());
  };
  ...
  function DateTimeComponents$Formats$RFC_1123$lambda($this$Format) {
    ...
    $this$Format.monthName_asbkgr_k$(Companion_getInstance_25().get_ENGLISH_ABBREVIATED_cfvc81_k$());
    char($this$Format, _Char___init__impl__6a9atx(32));
    ...
    char($this$Format, _Char___init__impl__6a9atx(58));
    $this$Format.minute$default_g584a9_k$();
    var tmp_0 = [DateTimeComponents$Formats$RFC_1123$lambda$lambda_1];
    alternativeParsing($this$Format, tmp_0, DateTimeComponents$Formats$RFC_1123$lambda$lambda_2);
    $this$Format.chars_pe6iqb_k$(' ');
    var tmp_1 = DateTimeComponents$Formats$RFC_1123$lambda$lambda_3;
    var tmp_2 = [tmp_1, DateTimeComponents$Formats$RFC_1123$lambda$lambda_4];
    alternativeParsing($this$Format, tmp_2, DateTimeComponents$Formats$RFC_1123$lambda$lambda_5);
    return Unit_getInstance();
  }
  ...
  function DateTimeComponents$Formats$RFC_1123$lambda$lambda_0($this$alternativeParsing) {
    $this$alternativeParsing.dayOfWeek_tn8lxa_k$(Companion_getInstance_19().get_ENGLISH_ABBREVIATED_cfvc81_k$());
    $this$alternativeParsing.chars_pe6iqb_k$(', ');
    return Unit_getInstance();
  }
  function DateTimeComponents$Formats$RFC_1123$lambda$lambda_1($this$alternativeParsing) {
    return Unit_getInstance();
  }
  ...
  function DateTimeComponents$Formats$RFC_1123$lambda$lambda_5($this$alternativeParsing) {
  ...
  protoOf(Companion_13).Format_xzgceo_k$ = function (block) {
  ...
  protoOf(Builder).dateTimeComponents_bpc9lu_k$ = function (format) {
    return this.actualBuilder_1.add_b6pdwl_k$((format instanceof DateTimeComponentsFormat ? format : THROW_CCE()).actualFormat_1);
  };
  ...
  protoOf(Companion_14).formatAsKotlinBuilderDsl_pv4218_k$ = function (format) {
    var tmp;
                ...
                if (!_this__u8e3s4.get_formats_9xs0wd_k$().isEmpty_y1axqb_k$()) {
                  ...
                  loop: while (index_0 < _this__u8e3s4.get_formats_9xs0wd_k$().get_size_woubt6_k$()) {
                    ...
                    searchConstant: while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
                      ...
                      var constantDirectives = constant.second.get_formats_9xs0wd_k$();
                      if ((_this__u8e3s4.get_formats_9xs0wd_k$().get_size_woubt6_k$() - index_0 | 0) >= constantDirectives.get_size_woubt6_k$()) {
                        ...
                        this_3.append_22ad7x_k$(constant.first);
  ...
  function secondFractionInternal(_this__u8e3s4, minLength, maxLength, grouping) {
    (isInterface(_this__u8e3s4, AbstractWithTimeBuilder) ? _this__u8e3s4 : THROW_CCE()).addFormatStructureForTime_h3r7lv_k$(new BasicFormatStructure(new FractionalSecondDirective(minLength, maxLength, grouping)));
  }
  ...
  protoOf(IncompleteLocalDate).toLocalDate_u88f42_k$ = function () {
    ...
    var tmp;
    if (dayOfYear == null) {
      tmp = LocalDate_init_$Create$(year, requireParsedField(this.get_monthNumber_nb47ls_k$(), 'monthNumber'), requireParsedField(this.day_1, 'day'));
    } else {
      // Inline function 'kotlin.also' call
      var this_0 = plus_1(LocalDate_init_$Create$(year, 1, 1), dayOfYear - 1 | 0, Companion_getInstance_7().get_DAY_18jw19_k$());
  ...
  protoOf(Companion_15).get_ENGLISH_FULL_w9oxw9_k$ = function () {
    return this.ENGLISH_FULL_1;
  };
  protoOf(Companion_15).get_ENGLISH_ABBREVIATED_cfvc81_k$ = function () {
  ...
  protoOf(Companion_16).build_o3smjo_k$ = function (block) {
  ...
  function toKotlinCode_0(_this__u8e3s4) {
    ...
    var tmp;
    if (equals(tmp0_subject, Companion_getInstance_19().ENGLISH_FULL_1.names_1)) {
      Companion_getInstance_19();
      tmp = 'DayOfWeekNames.' + 'ENGLISH_FULL';
    } else if (equals(tmp0_subject, Companion_getInstance_19().ENGLISH_ABBREVIATED_1.names_1)) {
      Companion_getInstance_19();
  ...
  protoOf(Companion_17).build_jyqq35_k$ = function (block) {
  ...
  protoOf(Companion_18).build_agwrib_k$ = function (block) {
  ...
  protoOf(Companion_19).get_NO_EXTRA_ZEROS_9wrjkp_k$ = function () {
    return this.NO_EXTRA_ZEROS_1;
  };
  protoOf(Companion_19).get_GROUP_BY_THREE_z0tc3l_k$ = function () {
  ...
  function FractionalSecondDirective(minDigits, maxDigits, zerosToAdd) {
    ...
    zerosToAdd = zerosToAdd === VOID ? Companion_getInstance_23().NO_EXTRA_ZEROS_1 : zerosToAdd;
  ...
  protoOf(Companion_20).build_dzztnl_k$ = function (block) {
  ...
  protoOf(Companion_21).get_ENGLISH_FULL_w9oxw9_k$ = function () {
    return this.ENGLISH_FULL_1;
  };
  protoOf(Companion_21).get_ENGLISH_ABBREVIATED_cfvc81_k$ = function () {
    return this.ENGLISH_ABBREVIATED_1;
  };
  ...
  protoOf(Companion_22).build_xjwtmz_k$ = function (block) {
  ...
  function toKotlinCode_1(_this__u8e3s4) {
    ...
    var tmp0_subject = _this__u8e3s4.names_1;
    var tmp;
    if (equals(tmp0_subject, Companion_getInstance_25().ENGLISH_FULL_1.names_1)) {
      Companion_getInstance_25();
      tmp = 'MonthNames.' + 'ENGLISH_FULL';
    } else if (equals(tmp0_subject, Companion_getInstance_25().ENGLISH_ABBREVIATED_1.names_1)) {
      Companion_getInstance_25();
  ...
  protoOf(AssignableString).trySetWithoutReassigning_itlg4a_k$ = function (container, newValue) {
    return this.trySetWithoutReassigning_nj495f_k$(container, (!(newValue == null) ? typeof newValue === 'string' : false) ? newValue : THROW_CCE());
  };
  ...
  function NamedEnumIntFieldFormatDirective(field, mapping, name) {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      destination.put_4fpzoq_k$(pair.first, pair.second);
    }
  ...
  protoOf(PropertyAccessor).trySetWithoutReassigning_itlg4a_k$ = function (container, newValue) {
    return this.trySetWithoutReassigning_of2ay6_k$(container, newValue);
  };
  ...
  protoOf(ConstantFormatStructure).parser_ggn3z5_k$ = function () {
    ...
    if (charSequenceLength(this_0) === 0) {
      ...
      if (isAsciiDigit(charCodeAt(this.string_1, 0))) {
        ...
        $l$block: {
          ...
          if (inductionVariable < last)
            do {
              ...
              if (!isAsciiDigit(it)) {
                tmp$ret$5 = substring(tmp0, 0, index);
                break $l$block;
              }
            }
             while (inductionVariable < last);
        ...
        this_1.add_utx5q5_k$(new NumberSpanParserOperation(listOf(new ConstantNumberConsumer(tmp$ret$5))));
          ...
          if (inductionVariable_0 <= last_0)
            do {
              ...
              if (!isAsciiDigit(it_0)) {
                tmp$ret$7 = substring_0(tmp0_0, index_0);
                break $l$block_0;
              }
            }
             while (inductionVariable_0 <= last_0);
      ...
      if (charSequenceLength(suffix) > 0) {
        if (isAsciiDigit(charCodeAt(suffix, suffix.length - 1 | 0))) {
            ...
            if (0 <= inductionVariable_1)
              do {
                ...
                if (!isAsciiDigit(it_1)) {
                  tmp$ret$10 = substring(suffix, 0, index_1 + 1 | 0);
                  break $l$block_1;
                }
              }
          ...
          this_1.add_utx5q5_k$(new PlainStringParserOperation(tmp$ret$10));
          var tmp$ret$12;
          $l$block_2: {
            ...
            if (0 <= inductionVariable_2)
              do {
                ...
                if (!isAsciiDigit(it_2)) {
                  tmp$ret$12 = substring_0(suffix, index_2 + 1 | 0);
                  break $l$block_2;
                }
              }
          ...
          this_1.add_utx5q5_k$(new NumberSpanParserOperation(listOf(new ConstantNumberConsumer(tmp$ret$12))));
        } else {
  ...
  protoOf(Companion_23).fromField_3ctjbq_k$ = function (field) {
  ...
  function OptionalFormatStructure(onZero, format) {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$2 = item.get_field_irdnf5_k$();
      destination.add_utx5q5_k$(tmp$ret$2);
    }
    // Inline function 'kotlin.collections.map' call
    ...
    while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$5 = Companion_getInstance_27().fromField_3ctjbq_k$(item_0);
  ...
  protoOf(OptionalFormatStructure).formatter_tykoui_k$ = function () {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$2 = new ComparisonPredicate(item.defaultValue_1, Accessor$getter$ref_0(item.accessor_1));
      destination.add_utx5q5_k$(tmp$ret$2);
    }
  ...
  protoOf(AlternativesParsingFormatStructure).parser_ggn3z5_k$ = function () {
    ...
    var tmp$ret$0 = this_0.build_nmwvly_k$();
    return new ParserStructure(tmp, tmp$ret$0);
  };
  ...
  protoOf(ConcatenatedFormatStructure).parser_ggn3z5_k$ = function () {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var item = _iterator__ex2g4s.next_20eer_k$();
      var tmp$ret$2 = item.parser_ggn3z5_k$();
      destination.add_utx5q5_k$(tmp$ret$2);
    }
  ...
  protoOf(ConcatenatedFormatStructure).formatter_tykoui_k$ = function () {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var item = _iterator__ex2g4s.next_20eer_k$();
      var tmp$ret$2 = item.formatter_tykoui_k$();
      destination.add_utx5q5_k$(tmp$ret$2);
    }
  ...
  protoOf(Truth).test_kxdenx_k$ = function (value) {
    return this.test_o6ugz1_k$(value);
  };
  var Truth_instance;
  ...
  protoOf(Companion_24).Ok_6vkbj8_k$ = function (indexOfNextUnparsed) {
    return _ParseResult___init__impl__gvz3cn(indexOfNextUnparsed);
  };
  protoOf(Companion_24).Error_ca056s_k$ = function (position, message) {
  ...
  function Parser__match_impl_nzt83d($this, input, initialContainer, startIndex) {
    ...
    if (errors.get_size_woubt6_k$() > 1) {
      ...
      var tmp$ret$12 = new sam$kotlin_Comparator$0(tmp_1);
      sortWith(errors, tmp$ret$12);
    }
  ...
  function Parser$match$lambda_0(a, b) {
    ...
    var tmp$ret$2 = a.get_position_jfponi_k$();
  ...
  function Companion_25() {
    ...
    this.serialVersionUID_1 = new Long(-1040988569, 1325082731);
  }
  ...
  function concat(_this__u8e3s4) {
    ...
    // Inline function 'kotlin.collections.mutableListOf' call
    var accumulatedOperations = ArrayList_init_$Create$_0();
    var _iterator__ex2g4s = asReversed(_this__u8e3s4).iterator_jk1svi_k$();
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var parser = _iterator__ex2g4s.next_20eer_k$();
      if (parser.followedBy_1.isEmpty_y1axqb_k$()) {
        accumulatedOperations.add_utx5q5_k$(parser.operations_1);
      } else {
  ...
  function concat$mergeOperations(baseOperations, numberSpan, unconditionalModifications, simplifiedParserStructure) {
    var operationsToMerge = simplifiedParserStructure.operations_1;
    var firstOperation = firstOrNull(operationsToMerge);
    // Inline function 'kotlin.collections.buildList' call
    // Inline function 'kotlin.collections.buildListInternal' call
    // Inline function 'kotlin.apply' call
    var this_0 = ArrayList_init_$Create$_0();
    this_0.addAll_4lagoh_k$(baseOperations);
    if (numberSpan == null) {
      this_0.addAll_4lagoh_k$(operationsToMerge);
    } else {
      if (firstOperation instanceof NumberSpanParserOperation) {
        this_0.add_utx5q5_k$(new NumberSpanParserOperation(plus_0(numberSpan, firstOperation.get_consumers_1jv82c_k$())));
        ...
        if (inductionVariable <= last)
          do {
            var i = inductionVariable;
            inductionVariable = inductionVariable + 1 | 0;
            this_0.add_utx5q5_k$(operationsToMerge.get_c1px32_k$(i));
          }
           while (!(i === last));
      } else {
        this_0.add_utx5q5_k$(new NumberSpanParserOperation(numberSpan));
        this_0.addAll_4lagoh_k$(operationsToMerge);
      }
    }
    this_0.addAll_4lagoh_k$(unconditionalModifications);
    var mergedOperations = this_0.build_nmwvly_k$();
    return new ParserStructure(mergedOperations, simplifiedParserStructure.followedBy_1);
  }
  function concat$simplifyAndAppend(_this__u8e3s4, other) {
    ...
    // Inline function 'kotlin.collections.mutableListOf' call
    var unconditionalModifications = ArrayList_init_$Create$_0();
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      if (op instanceof NumberSpanParserOperation) {
        ...
        if (op instanceof UnconditionalModification)
          unconditionalModifications.add_utx5q5_k$(op);
        else {
          if (!(currentNumberSpan == null)) {
            newOperations.add_utx5q5_k$(new NumberSpanParserOperation(currentNumberSpan));
            currentNumberSpan = null;
            newOperations.addAll_4lagoh_k$(unconditionalModifications);
            unconditionalModifications.clear_j9egeb_k$();
          }
    ...
    if (currentNumberSpan == null) {
      // Inline function 'kotlin.collections.isNotEmpty' call
      tmp_4 = !newOperations.isEmpty_y1axqb_k$();
    } else {
      tmp_4 = false;
    }
    if (tmp_4) {
      ...
      $l$block_0: {
        ...
        if (isInterface(mergedTails, Collection)) {
          tmp_5 = mergedTails.isEmpty_y1axqb_k$();
        } else {
          tmp_5 = false;
        }
        if (tmp_5) {
        ...
        while (_iterator__ex2g4s_1.hasNext_bitz1p_k$()) {
          ...
          var tmp_6 = firstOrNull(element_0.operations_1);
    ...
    if (tmp_3) {
      ...
      while (_iterator__ex2g4s_2.hasNext_bitz1p_k$()) {
        ...
        destination_0.add_utx5q5_k$(tmp$ret$15);
      }
  ...
  function concat$flushAccumulatedOperations(accumulatedOperations, result) {
    // Inline function 'kotlin.collections.isNotEmpty' call
    if (!accumulatedOperations.isEmpty_y1axqb_k$()) {
      // Inline function 'kotlin.collections.buildList' call
      // Inline function 'kotlin.collections.buildListInternal' call
      // Inline function 'kotlin.apply' call
      var this_0 = ArrayList_init_$Create$_0();
      var _iterator__ex2g4s = asReversed_0(accumulatedOperations).iterator_jk1svi_k$();
      while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
        var parserOperations = _iterator__ex2g4s.next_20eer_k$();
        this_0.addAll_4lagoh_k$(parserOperations);
      }
      var operations = this_0.build_nmwvly_k$();
      result._v = concat$simplifyAndAppend(new ParserStructure(operations, emptyList()), result._v);
      accumulatedOperations.clear_j9egeb_k$();
    }
  }
  ...
  function _init_$reduceTrie(trie) {
    ...
    var tmp$ret$2 = new sam$kotlin_Comparator$0_0(tmp);
    var tmp$ret$1 = sortedWith(newChildren, tmp$ret$2);
    trie.children_1.addAll_4lagoh_k$(tmp$ret$1);
  }
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      while (inductionVariable < last) {
        ...
        if (searchResult < 0) {
          ...
          tmp = node.children_1.get_c1px32_k$(searchResult).second;
        }
        node = tmp;
      }
      // Inline function 'kotlin.require' call
  ...
  function _get_whatThisExpects__4pg11j_0($this) {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$2 = (length == null ? 'at least one digit' : '' + length + ' digits') + (' for ' + item.get_whatThisExpects_s3n635_k$());
      destination.add_utx5q5_k$(tmp$ret$2);
    }
  ...
  function NumberSpanParserOperation(consumers) {
    ...
    if (!(tmp$ret$9 <= 1)) {
      ...
      while (_iterator__ex2g4s_4.hasNext_bitz1p_k$()) {
        ...
        var tmp$ret$18 = item.get_whatThisExpects_s3n635_k$();
        destination_0.add_utx5q5_k$(tmp$ret$18);
      }
  ...
  protoOf(NumberSpanParserOperation).consume_ew3o91_k$ = function (storage, input, startIndex) {
    ...
    if (inductionVariable <= last)
      do {
       ...
       while (inductionVariable <= last);
    return Companion_getInstance_28().Ok_6vkbj8_k$(index);
  };
  ...
  protoOf(PlainStringParserOperation).consume_ew3o91_k$ = function (storage, input, startIndex) {
    ...
    if (inductionVariable <= last)
      do {
       ...
       while (inductionVariable <= last);
    return Companion_getInstance_28().Ok_6vkbj8_k$(startIndex + this.string_1.length | 0);
  };
  ...
  function setWithoutReassigning_0(_this__u8e3s4, receiver, value, position, nextIndex) {
    ...
    if (conflictingValue === null) {
      tmp = Companion_getInstance_28().Ok_6vkbj8_k$(nextIndex);
    } else {
      var tmp_0 = Companion_getInstance_28();
  ...
  function onTrue($this, $receiver, action) {
    var tmp;
    if ($receiver) {
      action();
      tmp = true;
  ...
  function onFalse($this, $receiver, action) {
    var tmp;
    if ($receiver) {
      tmp = true;
    } else {
  ...
  protoOf(TimeZoneParserOperation).consume_ew3o91_k$ = function (storage, input, startIndex) {
    var lastMatch = validateTimeZone(Companion_getInstance_30(), input, startIndex);
    var tmp;
    if (lastMatch > startIndex) {
      ...
      tmp = Companion_getInstance_28().Ok_6vkbj8_k$(lastMatch);
    } else {
      var tmp_0 = Companion_getInstance_28();
  ...
  function spaceAndZeroPaddedUnsignedInt$numberOfRequiredLengths($withMinus, $setter, $name, minNumberLength, maxNumberLength) {
    ...
    var tmp$ret$1 = this_0.build_nmwvly_k$();
    return new ParserStructure(tmp$ret$1, emptyList());
  }
  ...
  function DateBasedDateTimeUnitSerializer$impl$delegate$lambda() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp$ret$3 = [DayBasedDateTimeUnitSerializer_getInstance(), MonthBasedDateTimeUnitSerializer_getInstance()];
  ...
  function DateTimeUnitSerializer$impl$delegate$lambda() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp$ret$3 = [DayBasedDateTimeUnitSerializer_getInstance(), MonthBasedDateTimeUnitSerializer_getInstance(), TimeBasedDateTimeUnitSerializer_getInstance()];
  ...
  protoOf(InstantSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_31().parse$default_czyhit_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(LocalDateSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_32().parse$default_krgov1_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(LocalDateTimeSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_33().parse$default_rpbnp3_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(LocalTimeSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_34().parse$default_id2jrv_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(UtcOffsetSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_35().parse$default_j5dbmh_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(YearMonthSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_36().parse$default_epr5sf_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  function tzdb$base60MinutesInSeconds(string) {
    ...
    if (inductionVariable <= last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var it = item;
        var tmp$ret$2 = tzdb$charCodeToInt(charCodeAt(whole, it));
        destination.add_utx5q5_k$(tmp$ret$2);
      }
       while (!(item === last));
        ...
        $l$block: {
          ...
          while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
            ...
            while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
              ...
              var tmp$ret$5 = UtcOffset_0(null, null, -convertToInt(tzdb$base60MinutesInSeconds(item)) | 0);
            ...
            while (inductionVariable < charSequenceLength(this_1)) {
              ...
              inductionVariable = inductionVariable + 1 | 0;
              var tmp$ret$8 = tzdb$charCodeToInt(item_0);
            ...
            while (_iterator__ex2g4s_1.hasNext_bitz1p_k$()) {
              ...
              var tmp$ret$11 = tzdb$base60MinutesInSeconds(item_1);
            ...
            while (_iterator__ex2g4s_2.hasNext_bitz1p_k$()) {
              ...
              var tmp$ret$20 = offsets.get_c1px32_k$(item_2);
  ...
  protoOf(Companion_27).get_MIN_za2zu4_k$ = function () {
    return this.MIN_1;
  };
  protoOf(Companion_27).get_MAX_ieaqrm_k$ = function () {
    return this.MAX_1;
  };
  protoOf(Companion_27).now_2cba_k$ = function () {
    return System_getInstance_0().now_2cba_k$();
  };
  protoOf(Companion_27).fromEpochMilliseconds_e2resj_k$ = function (epochMilliseconds) {
    // Inline function 'kotlin.floorDiv' call
  ...
  protoOf(Companion_27).fromEpochSeconds_labkcg_k$ = function (epochSeconds, nanosecondAdjustment) {
    var tmp;
    try {
  ...
  protoOf(Companion_27).fromEpochSeconds$default_ryd2jg_k$ = function (epochSeconds, nanosecondAdjustment, $super) {
  ...
  protoOf(Companion_27).fromEpochSeconds_idu11y_k$ = function (epochSeconds, nanosecondAdjustment) {
    return this.fromEpochSeconds_labkcg_k$(epochSeconds, fromInt(nanosecondAdjustment));
  };
  protoOf(Companion_27).parse_tkh7xn_k$ = function (input, format) {
    var tmp;
    try {
  ...
  protoOf(Companion_27).parse$default_czyhit_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_27).parse_pc1q8p_k$ = function (isoString) {
    return this.parse$default_czyhit_k$(isoString);
  };
  protoOf(Companion_27).get_DISTANT_PAST_yzdqbd_k$ = function () {
    return this.DISTANT_PAST_1;
  };
  protoOf(Companion_27).get_DISTANT_FUTURE_gftwmi_k$ = function () {
  ...
  protoOf(Instant).plus_jn5idf_k$ = function (secondsToAdd, nanosToAdd) {
    ...
    return fromEpochSecondsThrowing(Companion_getInstance_31(), newEpochSeconds, nanoAdjustment);
  };
  protoOf(Instant).plus_oeswd1_k$ = function (duration) {
    ...
    try {
      ...
      if ($p instanceof IllegalArgumentException) {
        var _unused_var__etf5q3 = $p;
        tmp_0 = Duration__isPositive_impl_tvkkt2(duration) ? Companion_getInstance_31().MAX_1 : Companion_getInstance_31().MIN_1;
      } else {
        if ($p instanceof ArithmeticException) {
          var _unused_var__etf5q3_0 = $p;
          tmp_0 = Duration__isPositive_impl_tvkkt2(duration) ? Companion_getInstance_31().MAX_1 : Companion_getInstance_31().MIN_1;
  ...
  function ISO_DATE_TIME_OFFSET_WITH_TRAILING_ZEROS$lambda$lambda_1($this$optional) {
    _init_properties_DeprecatedInstant_kt__voxe84();
    char($this$optional, _Char___init__impl__6a9atx(46));
    secondFractionInternal($this$optional, 1, 9, Companion_getInstance_23().get_GROUP_BY_THREE_z0tc3l_k$());
    return Unit_getInstance();
  }
  ...
  function LocalDate_init_$Init$(year, month, day, $this) {
    LocalDate.call($this, year, month, day, Unit_getInstance());
    var containsArg = $this._month_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 12 : false)) {
      var message = 'Invalid date: month must be a number between 1 and 12, got ' + $this._month_1;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  ...
  function LocalDate_init_$Init$_0(year, month, day, $this) {
    LocalDate.call($this, year, get_number(month), day, Unit_getInstance());
    validateYearAndDay($this);
    return $this;
  }
  function LocalDate_init_$Create$_0(year, month, day) {
    return LocalDate_init_$Init$_0(year, month, day, objectCreate(protoOf(LocalDate)));
  }
  function validateYearAndDay($this) {
    ...
    if (!(1 <= containsArg_0 ? containsArg_0 <= 31 : false)) {
      var message_0 = 'Invalid date: day of month must be a number between 1 and 31, got ' + $this.day_1;
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
    if ($this.day_1 > 28 && $this.day_1 > monthLength($this._month_1, isLeapYear($this.year_1))) {
      if ($this.day_1 === 29) {
        ...
        throw IllegalArgumentException_init_$Create$("Invalid date '" + $this.get_month_ivc8d3_k$().toString() + ' ' + $this.day_1 + "'");
      }
    }
  }
  function Companion_28() {
    Companion_instance_28 = this;
    this.MIN_1 = LocalDate_init_$Create$(-999999999, 1, 1);
    this.MAX_1 = LocalDate_init_$Create$(999999999, 12, 31);
    this.MIN_EPOCH_DAY_1 = new Long(-170999002, -86);
    this.MAX_EPOCH_DAY_1 = new Long(169560311, 85);
  }
  protoOf(Companion_28).parse_18ba6d_k$ = function (input, format) {
    return format.parse_xovy9i_k$(input);
  };
  protoOf(Companion_28).parse$default_krgov1_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_28).parse_pc1q8p_k$ = function (isoString) {
    return this.parse$default_krgov1_k$(isoString);
  };
  protoOf(Companion_28).orNull_kk2b8y_k$ = function (year, month, day) {
    var tmp;
    if (!(-999999999 <= year ? year <= 999999999 : false) || !(1 <= month ? month <= 12 : false) || !(1 <= day ? day <= 31 : false) || (day > 28 && day > monthLength(month, isLeapYear(year)))) {
      tmp = null;
    } else {
      tmp = new LocalDate(year, month, day, Unit_getInstance());
    }
    return tmp;
  };
  protoOf(Companion_28).orNull_vwcq9y_k$ = function (year, month, day) {
    return this.orNull_kk2b8y_k$(year, get_number(month), day);
  };
  protoOf(Companion_28).fromEpochDays_4kf494_k$ = function (epochDays) {
    // Inline function 'kotlin.require' call
    ...
    return new LocalDate(convertToInt(yearEst), month, dom, Unit_getInstance());
  };
  protoOf(Companion_28).fromEpochDays_msuzxa_k$ = function (epochDays) {
    return this.fromEpochDays_4kf494_k$(fromInt(epochDays));
  };
  protoOf(Companion_28).get_MIN_za2zu4_k$ = function () {
    return this.MIN_1;
  };
  protoOf(Companion_28).get_MAX_ieaqrm_k$ = function () {
    return this.MAX_1;
  };
  protoOf(Companion_28).get_MIN_EPOCH_DAY_w0tqhf_k$ = function () {
    return this.MIN_EPOCH_DAY_1;
  };
  protoOf(Companion_28).get_MAX_EPOCH_DAY_1y0jj9_k$ = function () {
    return this.MAX_EPOCH_DAY_1;
  };
  protoOf(Companion_28).Format_rqffoz_k$ = function (block) {
    return Companion_getInstance_20().build_o3smjo_k$(block);
  };
  ...
  function resolvePreviousValid($this, year, month, day) {
    ...
    return new LocalDate(year, month, newDay, Unit_getInstance());
  }
  ...
  protoOf(LocalDate).get_dayOfWeek_3kfgci_k$ = function () {
    ...
    var tmp$ret$2 = add(r, bitwiseAnd(other, shiftRight(bitwiseAnd(bitwiseXor(r, other), bitwiseOr(r, negate(r))), 63)));
  ...
  protoOf(LocalDate).plusMonths_koeule_k$ = function (monthsToAdd) {
    ...
    var tmp$ret$5 = add(r, bitwiseAnd(other_1, shiftRight(bitwiseAnd(bitwiseXor(r, other_1), bitwiseOr(r, negate(r))), 63)));
  ...
  protoOf(LocalDate).plusDays_h8gtdy_k$ = function (daysToAdd) {
    return equalsLong(daysToAdd, new Long(0, 0)) ? this : Companion_getInstance_32().fromEpochDays_4kf494_k$(safeAdd(this.toEpochDays_tp9eth_k$(), daysToAdd));
  };
  protoOf(LocalDate).rangeTo_sp93rh_k$ = function (that) {
    return Companion_getInstance_13().fromRangeTo_amidtb_k$(this, that);
  };
  protoOf(LocalDate).rangeUntil_6dh2as_k$ = function (that) {
    return Companion_getInstance_13().fromRangeUntil_qv8t66_k$(this, that);
  };
  ...
  function Companion_29() {
    ...
    this.MIN_1 = new LocalDateTime(Companion_getInstance_32().get_MIN_za2zu4_k$(), Companion_getInstance_34().get_MIN_za2zu4_k$());
    this.MAX_1 = new LocalDateTime(Companion_getInstance_32().get_MAX_ieaqrm_k$(), Companion_getInstance_34().get_MAX_ieaqrm_k$());
  }
  protoOf(Companion_29).orNull_ife9v6_k$ = function (year, month, day, hour, minute, second, nanosecond) {
    var tmp0_elvis_lhs = Companion_getInstance_32().orNull_kk2b8y_k$(year, month, day);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return null;
    } else {
    ...
    var date = tmp;
    var tmp1_elvis_lhs = Companion_getInstance_34().orNull_sb4j62_k$(hour, minute, second, nanosecond);
    var tmp_0;
    if (tmp1_elvis_lhs == null) {
      return null;
    } else {
  ...
  protoOf(Companion_29).orNull$default_vkf0fg_k$ = function (year, month, day, hour, minute, second, nanosecond, $super) {
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    return $super === VOID ? this.orNull_ife9v6_k$(year, month, day, hour, minute, second, nanosecond) : $super.orNull_ife9v6_k$.call(this, year, month, day, hour, minute, second, nanosecond);
  };
  protoOf(Companion_29).orNull_2u12y_k$ = function (year, month, day, hour, minute, second, nanosecond) {
    var tmp0_elvis_lhs = Companion_getInstance_32().orNull_vwcq9y_k$(year, month, day);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return null;
    } else {
  ...
  protoOf(Companion_29).orNull$default_qzmfls_k$ = function (year, month, day, hour, minute, second, nanosecond, $super) {
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    return $super === VOID ? this.orNull_2u12y_k$(year, month, day, hour, minute, second, nanosecond) : $super.orNull_2u12y_k$.call(this, year, month, day, hour, minute, second, nanosecond);
  };
  protoOf(Companion_29).parse_bq7xns_k$ = function (input, format) {
    return format.parse_xovy9i_k$(input);
  };
  protoOf(Companion_29).parse$default_rpbnp3_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_29).parse_pc1q8p_k$ = function (isoString) {
    return this.parse$default_rpbnp3_k$(isoString);
  };
  protoOf(Companion_29).get_MIN_za2zu4_k$ = function () {
    return this.MIN_1;
  };
  protoOf(Companion_29).get_MAX_ieaqrm_k$ = function () {
    return this.MAX_1;
  };
  protoOf(Companion_29).Format_52y7ju_k$ = function (builder) {
    return Companion_getInstance_21().build_jyqq35_k$(builder);
  };
  ...
  function LocalDateTime_init_$Init$(year, month, day, hour, minute, second, nanosecond, $this) {
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    LocalDateTime.call($this, LocalDate_init_$Create$(year, month, day), LocalTime_init_$Create$(hour, minute, second, nanosecond));
    return $this;
  }
  ...
  function LocalDateTime_init_$Init$_0(year, month, day, hour, minute, second, nanosecond, $this) {
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    LocalDateTime.call($this, LocalDate_init_$Create$_0(year, month, day), LocalTime_init_$Create$(hour, minute, second, nanosecond));
    return $this;
  }
  ...
  function plusSeconds(_this__u8e3s4, seconds) {
    ...
    var newTime = equalsLong(newNanoOfDay, currentNanoOfDay) ? _this__u8e3s4.time_1 : Companion_getInstance_34().ofNanoOfDay_vuj08f_k$(newNanoOfDay);
  ...
  function LocalTime_init_$Init$(hour, minute, second, nanosecond, $this) {
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    LocalTime.call($this, hour, minute, second, nanosecond, Unit_getInstance());
    _init_$check_eg57ze(hour, 0, 23, 'hour');
    _init_$check_eg57ze(minute, 0, 59, 'minute');
    _init_$check_eg57ze(second, 0, 59, 'second');
    _init_$check_eg57ze(nanosecond, 0, 999999999, 'nanosecond');
    return $this;
  }
  function LocalTime_init_$Create$(hour, minute, second, nanosecond) {
    return LocalTime_init_$Init$(hour, minute, second, nanosecond, objectCreate(protoOf(LocalTime)));
  }
  function Companion_30() {
    Companion_instance_30 = this;
    this.MIN_1 = LocalTime_init_$Create$(0, 0, 0, 0);
    this.MAX_1 = LocalTime_init_$Create$(23, 59, 59, 999999999);
  }
  protoOf(Companion_30).orNull_sb4j62_k$ = function (hour, minute, second, nanosecond) {
    var tmp;
    if (!(0 <= hour ? hour <= 23 : false) || !(0 <= minute ? minute <= 59 : false) || !(0 <= second ? second <= 59 : false) || !(0 <= nanosecond ? nanosecond < 1000000000 : false)) {
      tmp = null;
    } else {
      tmp = new LocalTime(hour, minute, second, nanosecond, Unit_getInstance());
    }
    return tmp;
  };
  protoOf(Companion_30).orNull$default_el74y0_k$ = function (hour, minute, second, nanosecond, $super) {
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    return $super === VOID ? this.orNull_sb4j62_k$(hour, minute, second, nanosecond) : $super.orNull_sb4j62_k$.call(this, hour, minute, second, nanosecond);
  };
  protoOf(Companion_30).parse_keg146_k$ = function (input, format) {
    return format.parse_xovy9i_k$(input);
  };
  protoOf(Companion_30).parse$default_id2jrv_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_30).parse_pc1q8p_k$ = function (isoString) {
    return this.parse$default_id2jrv_k$(isoString);
  };
  protoOf(Companion_30).fromSecondOfDay_ahegcx_k$ = function (secondOfDay) {
    return this.ofSecondOfDay_9u5rnn_k$(secondOfDay, 0);
  };
  protoOf(Companion_30).fromMillisecondOfDay_pjhtva_k$ = function (millisecondOfDay) {
    // Inline function 'kotlin.Long.times' call
  ...
  protoOf(Companion_30).fromNanosecondOfDay_iksazp_k$ = function (nanosecondOfDay) {
    return this.ofNanoOfDay_vuj08f_k$(nanosecondOfDay);
  };
  protoOf(Companion_30).ofSecondOfDay_9u5rnn_k$ = function (secondOfDay, nanoOfSecond) {
    // Inline function 'kotlin.require' call
    if (!(0 <= secondOfDay ? secondOfDay < 86400 : false)) {
      var message = 'Invalid time: secondOfDay must be between 0 and 86400, got ' + secondOfDay;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(0 <= nanoOfSecond ? nanoOfSecond < 1000000000 : false)) {
      var message_0 = 'Invalid time: nanosecondOfSecond must be between 0 and 1000000000, got ' + nanoOfSecond;
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
    ...
    return new LocalTime(hours, minutes, second, nanoOfSecond, Unit_getInstance());
  };
  protoOf(Companion_30).ofNanoOfDay_vuj08f_k$ = function (nanoOfDay) {
    var tmp;
    ...
    // Inline function 'kotlin.require' call
    if (!tmp) {
      var message = 'Invalid time: nanosecondOfDay must be between 0 and 86_400_000_000_000, got ' + nanoOfDay.toString();
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    ...
    // Inline function 'kotlin.Long.div' call
    var other_0 = 1000000000;
    var tmp$ret$3 = divide(tmp0_0, fromInt(other_0));
    var seconds = convertToInt(tmp$ret$3);
    var tmp0_1 = newNanoOfDay;
    // Inline function 'kotlin.Long.minus' call
    var other_1 = imul(seconds, 1000000000);
    newNanoOfDay = subtract(tmp0_1, fromInt(other_1));
    return new LocalTime(hours, minutes, seconds, convertToInt(newNanoOfDay), Unit_getInstance());
  };
  protoOf(Companion_30).get_MIN_za2zu4_k$ = function () {
    return this.MIN_1;
  };
  protoOf(Companion_30).get_MAX_ieaqrm_k$ = function () {
    return this.MAX_1;
  };
  protoOf(Companion_30).Format_tnsr8s_k$ = function (builder) {
    return Companion_getInstance_22().build_agwrib_k$(builder);
  };
  ...
  function _init_$check_eg57ze(value, lower, upper, str) {
    // Inline function 'kotlin.require' call
  ...
  function LocalTime(hour, minute, second, nanosecond, unit) {
  ...
  function toLocalDateTimeImpl(_this__u8e3s4, offset) {
    ...
    var date = Companion_getInstance_32().fromEpochDays_4kf494_k$(localEpochDay);
    var time = Companion_getInstance_34().ofSecondOfDay_9u5rnn_k$(secsOfDay, _this__u8e3s4.get_nanosecondsOfSecond_n2ey8j_k$());
    return new LocalDateTime(date, time);
  }
  ...
  var utcOffsetCache;
  function totalSecondsValid($this, totalSeconds) {
    return -64800 <= totalSeconds ? totalSeconds <= 64800 : false;
  }
  function validateTotal($this, totalSeconds) {
    // Inline function 'kotlin.require' call
    if (!totalSecondsValid($this, totalSeconds)) {
      var message = 'Total seconds value is out of range: ' + totalSeconds;
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  ...
  function hoursMinutesSecondsValid($this, hours, minutes, seconds) {
    return (-18 <= hours ? hours <= 18 : false) && (-59 <= minutes ? minutes <= 59 : false) && (-59 <= seconds ? seconds <= 59 : false) && !(hours > 0 && (minutes < 0 || seconds < 0)) && !(hours < 0 && (minutes > 0 || seconds > 0)) && !(minutes > 0 && seconds < 0 || (minutes < 0 && seconds > 0)) && !(abs(hours) === 18 && (abs(minutes) > 0 || abs(seconds) > 0));
  }
  function ofSecondsUnsafe($this, seconds) {
    var tmp;
    if ((seconds % 900 | 0) === 0) {
  ...
  protoOf(Companion_31).get_ZERO_wodlgx_k$ = function () {
    return this.ZERO_1;
  };
  protoOf(Companion_31).orNull_cuu3zd_k$ = function (hours, minutes, seconds) {
    var tmp;
    if (!(hours == null)) {
      var tmp_0 = minutes == null ? 0 : minutes;
      tmp = this.ofHoursMinutesSecondsOrNull_5pvpu5_k$(hours, tmp_0, seconds == null ? 0 : seconds);
    } else if (!(minutes == null)) {
      var tmp_1 = minutes / 60 | 0;
      var tmp_2 = minutes % 60 | 0;
      tmp = this.ofHoursMinutesSecondsOrNull_5pvpu5_k$(tmp_1, tmp_2, seconds == null ? 0 : seconds);
    } else {
      tmp = this.ofSecondsOrNull_4k6abh_k$(seconds == null ? 0 : seconds);
    }
    return tmp;
  };
  protoOf(Companion_31).orNull$default_vulx7r_k$ = function (hours, minutes, seconds, $super) {
    hours = hours === VOID ? null : hours;
    minutes = minutes === VOID ? null : minutes;
    seconds = seconds === VOID ? null : seconds;
    return $super === VOID ? this.orNull_cuu3zd_k$(hours, minutes, seconds) : $super.orNull_cuu3zd_k$.call(this, hours, minutes, seconds);
  };
  protoOf(Companion_31).parse_i4pxzt_k$ = function (input, format) {
    return format.parse_xovy9i_k$(input);
  };
  protoOf(Companion_31).parse$default_j5dbmh_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_31).parse_pc1q8p_k$ = function (offsetString) {
    return this.parse$default_j5dbmh_k$(offsetString);
  };
  protoOf(Companion_31).ofHoursMinutesSecondsUnsafe_oitui1_k$ = function (hours, minutes, seconds) {
    return hours === 0 && minutes === 0 && seconds === 0 ? this.ZERO_1 : this.ofSeconds_lh5225_k$((imul(hours, 3600) + imul(minutes, 60) | 0) + seconds | 0);
  };
  protoOf(Companion_31).ofHoursMinutesSeconds_hty6al_k$ = function (hours, minutes, seconds) {
    validate(this, hours, minutes, seconds);
    return this.ofHoursMinutesSecondsUnsafe_oitui1_k$(hours, minutes, seconds);
  };
  protoOf(Companion_31).ofHoursMinutesSecondsOrNull_5pvpu5_k$ = function (hours, minutes, seconds) {
    var tmp;
    if (hoursMinutesSecondsValid(this, hours, minutes, seconds)) {
      tmp = this.ofHoursMinutesSecondsUnsafe_oitui1_k$(hours, minutes, seconds);
    } else {
      tmp = null;
    }
    return tmp;
  };
  protoOf(Companion_31).ofSeconds_lh5225_k$ = function (seconds) {
    validateTotal(this, seconds);
    // Inline function 'kotlin.let' call
    return ofSecondsUnsafe(Companion_getInstance_35(), seconds);
  };
  protoOf(Companion_31).ofSecondsOrNull_4k6abh_k$ = function (seconds) {
    return totalSecondsValid(this, seconds) ? ofSecondsUnsafe(this, seconds) : null;
  };
  protoOf(Companion_31).Format_lu8ljq_k$ = function (block) {
    return Companion_getInstance_24().build_dzztnl_k$(block);
  };
  ...
  function UtcOffset_0(hours, minutes, seconds) {
    ...
    if (!(hours == null)) {
      ...
      var tmp_5 = Companion_getInstance_35();
  ...
  function validateYear($this) {
    ...
    // Inline function 'kotlin.require' call
    if (!(-999999999 <= containsArg ? containsArg <= 999999999 : false)) {
      var message = 'Year ' + $this.year_1 + ' is out of range: -999999999..999999999';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  function YearMonth_init_$Init$(year, month, $this) {
    YearMonth.call($this, year, month, Unit_getInstance());
    var containsArg = $this.monthNumber_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 12 : false)) {
  ...
  function YearMonth_init_$Init$_0(year, month, $this) {
    YearMonth.call($this, year, get_number(month), Unit_getInstance());
    validateYear($this);
    return $this;
  }
  function YearMonth_init_$Create$_0(year, month) {
    return YearMonth_init_$Init$_0(year, month, objectCreate(protoOf(YearMonth)));
  }
  function Companion_32() {
    Companion_instance_32 = this;
  }
  protoOf(Companion_32).orNull_8gbss6_k$ = function (year, month) {
    return !(-999999999 <= year ? year <= 999999999 : false) || !(1 <= month ? month <= 12 : false) ? null : new YearMonth(year, month, Unit_getInstance());
  };
  protoOf(Companion_32).orNull_iv1x9a_k$ = function (year, month) {
    return !(-999999999 <= year ? year <= 999999999 : false) ? null : new YearMonth(year, get_number(month), Unit_getInstance());
  };
  protoOf(Companion_32).parse_ziaw5h_k$ = function (input, format) {
    return format.parse_xovy9i_k$(input);
  };
  protoOf(Companion_32).parse$default_epr5sf_k$ = function (input, format, $super) {
  ...
  protoOf(Companion_32).Format_1myt4u_k$ = function (block) {
    return Companion_getInstance_26().build_xjwtmz_k$(block);
  };
  ...
  protoOf(YearMonth).rangeTo_lubll9_k$ = function (that) {
    return Companion_getInstance_15().fromRangeTo_pznalr_k$(this, that);
  };
  protoOf(YearMonth).rangeUntil_hgfvg_k$ = function (that) {
    return Companion_getInstance_15().fromRangeUntil_bi3wdq_k$(this, that);
  };
  ...
  protoOf(TransitionLocaltime).resolve_nlx7rb_k$ = function (date) {
    return plusSeconds(atTime(date, LocalTime_init_$Create$(0, 0)), this.seconds_1);
  };
  protoOf(TransitionLocaltime).toString = function () {
    return this.seconds_1 < 86400 ? Companion_getInstance_34().ofSecondOfDay_9u5rnn_k$(this.seconds_1, 0).toString() : '' + this.seconds_1 + ' seconds since the day start';
  };
  ...
  function RecurringZoneRules$rulesForYear$lambda(a, b) {
    ...
    var tmp$ret$2 = b.transitionDateTime_1;
    return compareValues(tmp, tmp$ret$2);
  }
  ...
  protoOf(RecurringZoneRules).rulesForYear_x4abwp_k$ = function (year) {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$2 = new Rule(transitionInstant, item.offsetBefore_1, item.offsetAfter_1);
      destination.add_utx5q5_k$(tmp$ret$2);
    }
    // Inline function 'kotlin.collections.sortedBy' call
    // Inline function 'kotlin.comparisons.compareBy' call
    ...
    return sortedWith(destination, tmp$ret$4);
  };
