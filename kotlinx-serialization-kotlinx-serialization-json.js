(function (factory) {
  ...
  var toDouble = kotlin_kotlin.$_$.gh;
  ...
  var toULongOrNull = kotlin_kotlin.$_$.oh;
  ...
  var toBooleanStrictOrNull = kotlin_kotlin.$_$.dh;
  ...
  var DeepRecursiveFunction = kotlin_kotlin.$_$.gi;
  var invoke = kotlin_kotlin.$_$.lj;
  var CoroutineImpl = kotlin_kotlin.$_$.qa;
  var DeepRecursiveScope = kotlin_kotlin.$_$.hi;
  ...
  var substringBefore = kotlin_kotlin.$_$.yg;
  var removeSuffix = kotlin_kotlin.$_$.jg;
  var substringAfter = kotlin_kotlin.$_$.vg;
  var contains_0 = kotlin_kotlin.$_$.if;
  var plus = kotlin_kotlin.$_$.sj;
  ...
  var last_0 = kotlin_kotlin.$_$.n8;
  var removeLast = kotlin_kotlin.$_$.z8;
  var lastIndexOf = kotlin_kotlin.$_$.dg;
  ...
  var chunked = kotlin_kotlin.$_$.ff;
  ...
  initMetadataForClass(JsonObject, 'JsonObject', VOID, JsonElement, [JsonElement, KtMap], VOID, VOID, makeAssociatedObjectMapES5([SerializableWith, JsonObjectSerializer_getInstance]));
  ...
  initMetadataForClass(JsonArray, 'JsonArray', VOID, JsonElement, [JsonElement, KtList], VOID, VOID, makeAssociatedObjectMapES5([SerializableWith, JsonArraySerializer_getInstance]));
  initMetadataForObject(JsonNull, 'JsonNull', VOID, JsonPrimitive, [JsonPrimitive, SerializerFactory], VOID, VOID, makeAssociatedObjectMapES5([SerializableWith, JsonNullSerializer_getInstance]));
  ...
  function buildDeserializationNamesMap$putOrThrow(_this__u8e3s4, $this_buildDeserializationNamesMap, name, index) {
    ...
    if ((isInterface(_this__u8e3s4, KtMap) ? _this__u8e3s4 : THROW_CCE()).containsKey_aw81wo_k$(name)) {
      throw new JsonDecodingException("The suggested name '" + name + "' for " + entity + ' ' + $this_buildDeserializationNamesMap.getElementName_u4sqmf_k$(index) + ' is already one of the names for ' + entity + ' ' + ($this_buildDeserializationNamesMap.getElementName_u4sqmf_k$(getValue(_this__u8e3s4, name)) + ' in ' + toString($this_buildDeserializationNamesMap)));
    }
      ...
      if (decodingKey) {
        if ($this.currentIndex_1 === -1) {
          ...
          if (!condition_0) {
            ...
            tmp0_0.fail$default_vqx2ls_k$(tmp$ret$2, position_0);
          }
        }
      }
  ...
  protoOf(StreamingJsonEncoder).encodeFloat_b8b85a_k$ = function (value) {
    ...
    if (!this.configuration_1.get_allowSpecialFloatingPointValues_1eu5hp_k$() && !isFinite(value)) {
      throw InvalidFloatingPointEncoded(value, toString(this.composer_1.get_writer_fne0c5_k$()));
    }
  };
  ...
  protoOf(AbstractJsonTreeDecoder).getPrimitiveValue_cue515_k$ = function (tag, descriptor) {
    ...
    if (!(tmp2 instanceof JsonPrimitive)) {
      var tmp = getKClass(JsonPrimitive).get_simpleName_r6f8py_k$();
      var tmp_0 = getKClassFromExpression(tmp2).get_simpleName_r6f8py_k$();
      var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_0(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(tmp2));
    }
    return tmp2;
  };
  protoOf(AbstractJsonTreeDecoder).decodeTaggedEnum_lbnta6_k$ = function (tag, enumDescriptor) {
    ...
    if (!(tmp2 instanceof JsonPrimitive)) {
      ...
      var tmp_1 = getKClassFromExpression(tmp2).get_simpleName_r6f8py_k$();
      var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedInline_tuyvom_k$ = function (tag, inlineDescriptor) {
    ...
    if (get_isUnsignedNumber(inlineDescriptor)) {
      ...
      if (!(tmp2 instanceof JsonPrimitive)) {
        ...
        var tmp_2 = getKClassFromExpression(tmp2).get_simpleName_r6f8py_k$();
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
