(function (factory) {
  ...
  function Companion() {
    ...
    this.f14_1 = new ByteString(new Int8Array(0), null);
    this.g14_1 = toCharArray('0123456789abcdef');
  }
  protoOf(Companion).h14 = function (byteArray) {
  ...
  protoOf(ByteString).equals = function (other) {
    ...
    if (!(other instanceof ByteString))
      THROW_CCE();
    if (!(other.i14_1.length === this.i14_1.length))
      return false;
    if (!(other.j14_1 === 0) && !(this.j14_1 === 0) && !(other.j14_1 === this.j14_1))
      return false;
    return contentEquals(this.i14_1, other.i14_1);
  };
  protoOf(ByteString).hashCode = function () {
    var hc = this.j14_1;
    if (hc === 0) {
      hc = contentHashCode(this.i14_1);
      this.j14_1 = hc;
    }
    return hc;
  };
  protoOf(ByteString).d1 = function (index) {
    ...
    return this.i14_1[index];
  };
  protoOf(ByteString).k14 = function (startIndex, endIndex) {
    var tmp;
    if (startIndex === endIndex) {
      tmp = Companion_getInstance().f14_1;
    } else {
      tmp = ByteString_init_$Create$(this.i14_1, startIndex, endIndex);
    }
    return tmp;
  };
  protoOf(ByteString).l14 = function (startIndex, endIndex, $super) {
    endIndex = endIndex === VOID ? this.e1() : endIndex;
    return $super === VOID ? this.k14(startIndex, endIndex) : $super.k14.call(this, startIndex, endIndex);
  };
  protoOf(ByteString).m14 = function (other) {
    if (other === this)
      return 0;
    var localData = this.i14_1;
    var otherData = other.i14_1;
  ...
  protoOf(ByteString).d = function (other) {
    return this.m14(other instanceof ByteString ? other : THROW_CCE());
  };
  protoOf(ByteString).toString = function () {
    ...
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.s(Companion_getInstance().g14_1[(b >>> 4 | 0) & 15]);
        $this$with.s(Companion_getInstance().g14_1[b & 15]);
      }
       while (inductionVariable < last);
    return $this$with.s(_Char___init__impl__6a9atx(41)).toString();
  };
  protoOf(ByteString).n14 = function () {
    return this.i14_1;
  };
  function ByteString_0(bytes) {
    ...
    if (bytes.length === 0) {
      ...
      tmp = Companion_getInstance().h14(bytes);
    }
    return tmp;
  }
  function decodeToString_0(_this__u8e3s4) {
    return decodeToString(_this__u8e3s4.n14());
  }
  ...
  protoOf(UnsafeByteStringOperations).o14 = function (array) {
    return Companion_getInstance().h14(array);
  };
