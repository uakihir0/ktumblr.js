(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    root['ktumblr-core'] = factory(typeof this['ktumblr-core'] === 'undefined' ? {} : this['ktumblr-core'], this['kotlin-kotlin-stdlib'], this['kotlinx-serialization-kotlinx-serialization-core'], this['kotlinx-coroutines-core'], khttpclient, kmpcommon, this['ktor-ktor-http'], this['kotlinx-serialization-kotlinx-serialization-json']);
  }
}(globalThis, function (_, kotlin_kotlin, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core, kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core, kotlin_work_socialhub_khttpclient, kotlin_work_socialhub_kmpcommon, kotlin_io_ktor_ktor_http, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_json) {
  'use strict';
  //region block: imports
  var imul = Math.imul;
  var protoOf = kotlin_kotlin.$_$.rb;
  var initMetadataForInterface = kotlin_kotlin.$_$.ua;
  ...
  var initMetadataForObject = kotlin_kotlin.$_$.wa;
  ...
  var ReferenceArraySerializer = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.w1;
  var THROW_IAE = kotlin_kotlin.$_$.vf;
  ...
  var throwArrayMissingFieldException = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.z1;
  ...
  var initMetadataForLambda = kotlin_kotlin.$_$.va;
  var runBlocking = kotlin_work_socialhub_kmpcommon.$_$.b;
  var emptyMap = kotlin_kotlin.$_$.g7;
  var SuspendFunction1 = kotlin_kotlin.$_$.u9;
  ...
  var Companion_getInstance = kotlin_io_ktor_ktor_http.$_$.l;
  var set_encodedPath = kotlin_io_ktor_ktor_http.$_$.n1;
  ...
  initMetadataForClass(Blog, 'Blog', Blog, Resource, VOID, VOID, VOID, {0: $serializer_getInstance_12});
  ...
  initMetadataForClass(LegacyAnswerPost, 'LegacyAnswerPost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_16});
  initMetadataForCompanion(Companion_19);
  initMetadataForObject($serializer_18, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(LegacyAudioPost, 'LegacyAudioPost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_17});
  initMetadataForCompanion(Companion_20);
  initMetadataForObject($serializer_19, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(LegacyChatPost, 'LegacyChatPost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_18});
  initMetadataForCompanion(Companion_21);
  initMetadataForObject($serializer_20, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(LegacyLinkPost, 'LegacyLinkPost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_19});
  initMetadataForCompanion(Companion_22);
  initMetadataForObject($serializer_21, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(LegacyPhotoPost, 'LegacyPhotoPost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_20});
  initMetadataForCompanion(Companion_23);
  initMetadataForObject($serializer_22, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(LegacyQuotePost, 'LegacyQuotePost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_21});
  initMetadataForCompanion(Companion_24);
  initMetadataForObject($serializer_23, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(LegacyTextPost, 'LegacyTextPost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_22});
  initMetadataForCompanion(Companion_25);
  initMetadataForObject($serializer_24, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(LegacyVideoPost, 'LegacyVideoPost', VOID, Post, VOID, VOID, VOID, {0: $serializer_getInstance_23});
  ...
  initMetadataForClass(User, 'User', User, Resource, VOID, VOID, VOID, {0: $serializer_getInstance_32});
  ...
  protoOf(AuthAuthorizeUrlRequest).toMap_1tsnvl_k$ = function () {
    ...
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.auth.AuthAuthorizeUrlRequest.toMap.<anonymous>' call
  ...
  protoOf(AuthOAuth2TokenRefreshRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.auth.AuthOAuth2TokenRefreshRequest.toMap.<anonymous>' call
  ...
  protoOf(AuthOAuth2TokenRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.auth.AuthOAuth2TokenRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'grant_type', this.grantType);
  ...
  protoOf(BlogDraftsRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.BlogDraftsRequest.toMap.<anonymous>' call
  ...
  protoOf(BlogFollowersRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.BlogFollowersRequest.toMap.<anonymous>' call
  ...
  protoOf(BlogFollowingRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.BlogFollowingRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'limit', this.limit);
    this.addParam_z3s3jk_k$(this_0, 'offset', this.offset);
    return this_0;
  };
  ...
  protoOf(BlogLikesRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.BlogLikesRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'limit', this.limit);
    this.addParam_z3s3jk_k$(this_0, 'offset', this.offset);
  ...
  protoOf(BlogPostsRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.BlogPostsRequest.toMap.<anonymous>' call
  ...
  protoOf(BlogQueueRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.BlogQueueRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'limit', this.limit);
    this.addParam_z3s3jk_k$(this_0, 'offset', this.offset);
    this.addParam_z3s3jk_k$(this_0, 'filter', this.filter);
    return this_0;
  ...
  protoOf(BlogSubmissionsRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.BlogSubmissionsRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'offset', this.offset);
    this.addParam_z3s3jk_k$(this_0, 'filter', this.filter);
    return this_0;
  };
  ...
  protoOf(BlogAudioPostRequest).toMap_1tsnvl_k$ = function () {
    ...
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogAudioPostRequest.toMap.<anonymous>' call
  ...
  protoOf(BlogChatPostRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = this.toBaseMap_x09z5c_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogChatPostRequest.toMap.<anonymous>' call
  ...
  protoOf(BlogDeleteRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogDeleteRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'id', this.id);
    return this_0;
  };
  ...
  protoOf(BlogLinkPostRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = this.toBaseMap_x09z5c_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogLinkPostRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'title', this.title);
  ...
  protoOf(BlogPhotoPostRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = this.toBaseMap_x09z5c_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogPhotoPostRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'caption', this.caption);
  ...
  protoOf(BlogPhotoPostRequest).toFileMap_tdtkqt_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogPhotoPostRequest.toFileMap.<anonymous>' call
    ...
    if (tmp0_safe_receiver == null)
      ...
      while (inductionVariable < last) {
        ...
        // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogPhotoPostRequest.toFileMap.<anonymous>.<anonymous>' call
        var tmp1 = index;
        index = tmp1 + 1 | 0;
        // Inline function 'kotlin.collections.set' call
        var key = 'data[' + tmp1 + ']';
  ...
  protoOf(BlogPostRequest).toBaseMap_x09z5c_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogPostRequest.toBaseMap.<anonymous>' call
  ...
  protoOf(BlogQuotePostRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = this.toBaseMap_x09z5c_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogQuotePostRequest.toMap.<anonymous>' call
  ...
  protoOf(BlogReblogRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogReblogRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'id', this.id);
  ...
  protoOf(BlogTextPostRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = this.toBaseMap_x09z5c_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogTextPostRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'title', this.title);
  ...
  protoOf(BlogVideoPostRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = this.toBaseMap_x09z5c_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.blog.post.BlogVideoPostRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'caption', this.caption);
  ...
  protoOf(TaggedRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.tagged.TaggedRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'tag', this.tag);
    this.addParam_z3s3jk_k$(this_0, 'before', this.before);
    this.addParam_z3s3jk_k$(this_0, 'limit', this.limit);
    this.addParam_z3s3jk_k$(this_0, 'filter', this.filter);
  ...
  protoOf(UserDashboardRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.user.UserDashboardRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'limit', this.limit);
    this.addParam_z3s3jk_k$(this_0, 'offset', this.offset);
  ...
  protoOf(UserFollowRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.user.UserFollowRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'url', this.url);
  ...
  protoOf(UserFollowingRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.user.UserFollowingRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'limit', this.limit);
    this.addParam_z3s3jk_k$(this_0, 'offset', this.offset);
    return this_0;
  };
  ...
  protoOf(UserLikeRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.user.UserLikeRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'id', this.id);
    this.addParam_z3s3jk_k$(this_0, 'reblog_key', this.reblogKey);
    return this_0;
  };
  ...
  protoOf(UserLikesRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.user.UserLikesRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'limit', this.limit);
    this.addParam_z3s3jk_k$(this_0, 'offset', this.offset);
    this.addParam_z3s3jk_k$(this_0, 'before', this.before);
    this.addParam_z3s3jk_k$(this_0, 'after', this.after);
  ...
  protoOf(UserUnfollowRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.user.UserUnfollowRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'url', this.url);
    return this_0;
  };
  ...
  protoOf(UserUnlikeRequest).toMap_1tsnvl_k$ = function () {
    ...
    var this_0 = LinkedHashMap_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.api.request.user.UserUnlikeRequest.toMap.<anonymous>' call
    this.addParam_z3s3jk_k$(this_0, 'id', this.id);
    this.addParam_z3s3jk_k$(this_0, 'reblog_key', this.reblogKey);
    return this_0;
  };
  ...
  protoOf(Response).copy = function (data, json, status, message, $super) {
    ...
    return this.copy_ixnsn6_k$(data, json, status, message);
  };
  ...
  protoOf(Response).equals = function (other) {
    ...
    if (!equals(this.data, tmp0_other_with_cast.data))
      return false;
    if (!(this.json === tmp0_other_with_cast.json))
      return false;
  ...
  function Companion_2() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, new ReferenceArraySerializer(getKClass(FollowerUser), $serializer_getInstance_31())];
  }
  ...
  protoOf($serializer_2).serialize_j6rvci_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 1) ? true : !(value.users == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 1, tmp2_cached[1], value.users);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  protoOf($serializer_2).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp6_input.decodeSequentially_xlblqy_k$()) {
      tmp4_local0 = tmp6_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 0, IntSerializer_getInstance(), tmp4_local0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp6_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 1, tmp7_cached[1], tmp5_local1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp6_input.decodeElementIndex_bstkhp_k$(tmp0_desc);
  ...
  protoOf($serializer_2).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(IntSerializer_getInstance()), get_nullable(tmp0_cached[1])];
  };
  ...
  function Companion_3() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [new ReferenceArraySerializer(getKClass(Blog), $serializer_getInstance_12()), null];
  }
  ...
  protoOf($serializer_3).serialize_z42hsi_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 0) ? true : !(value.blogs == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 0, tmp2_cached[0], value.blogs);
    }
  ...
  protoOf($serializer_3).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp6_input.decodeSequentially_xlblqy_k$()) {
      tmp4_local0 = tmp6_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 0, tmp7_cached[0], tmp4_local0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
  ...
  protoOf($serializer_3).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(tmp0_cached[0]), get_nullable(IntSerializer_getInstance())];
  };
  ...
  function Companion_5() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [new ReferenceArraySerializer(getKClass(Post), PostSerializer_getInstance()), null];
  }
  ...
  protoOf($serializer_5).serialize_by47pj_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 0) ? true : !(value.likedPosts == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 0, tmp2_cached[0], value.likedPosts);
    }
  ...
  function Companion_6() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, new ReferenceArraySerializer(getKClass(Post), PostSerializer_getInstance()), null];
  }
  ...
  protoOf($serializer_6).serialize_useob4_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 1) ? true : !(value.posts == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 1, tmp2_cached[1], value.posts);
    }
  ...
  protoOf($serializer_6).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable($serializer_getInstance_12()), get_nullable(tmp0_cached[1]), get_nullable(IntSerializer_getInstance())];
  };
  ...
  function Companion_7() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [new ReferenceArraySerializer(getKClass(Post), PostSerializer_getInstance())];
  }
  ...
  protoOf($serializer_7).serialize_1cu5vz_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 0) ? true : !(value.posts == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 0, tmp2_cached[0], value.posts);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  function Companion_8() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, new ReferenceArraySerializer(getKClass(Blog), $serializer_getInstance_12())];
  }
  ...
  protoOf($serializer_8).serialize_8smw26_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 1) ? true : !(value.blogs == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 1, tmp2_cached[1], value.blogs);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  function Companion_13() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(BlogAvatar), $serializer_getInstance_13()), null, null, null, null, null, null, null];
  }
  ...
  protoOf($serializer_13).serialize_6m6nb1_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 10) ? true : !(value.avatar == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 10, tmp2_cached[10], value.avatar);
    }
  ...
  protoOf($serializer_13).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp22_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp14_local10 = tmp22_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 10, tmp23_cached[10], tmp14_local10);
  ...
  function Companion_18() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30()), null, null, null, null];
  }
  ...
  protoOf($serializer_17).serialize_e97lzf_k$ = function (encoder, value) {
    ...
    tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 10, tmp2_cached[10], value.tags_1);
    ...
    tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 36, tmp2_cached[36], value.notes_1);
    ...
    tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 39, tmp2_cached[39], value.trail_1);
  ...
  protoOf($serializer_17).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp49_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp3_bitMask0 = tmp3_bitMask0 | 512;
      tmp15_local10 = tmp49_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 10, tmp50_cached[10], tmp15_local10);
      tmp3_bitMask0 = tmp3_bitMask0 | 1024;
      ...
      tmp41_local36 = tmp49_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 36, tmp50_cached[36], tmp41_local36);
      ...
      tmp44_local39 = tmp49_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 39, tmp50_cached[39], tmp44_local39);
  ...
  protoOf($serializer_17).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(tmp0_cached[10]), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(tmp0_cached[36]), get_nullable($serializer_getInstance_12()), get_nullable($serializer_getInstance_15()), get_nullable(tmp0_cached[39]), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance())];
  };
  ...
  function Companion_19() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30()), null];
  }
  ...
  protoOf($serializer_18).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp46_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp3_bitMask0 = tmp3_bitMask0 | 512;
      tmp15_local10 = tmp46_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 10, tmp47_cached[10], tmp15_local10);
      tmp3_bitMask0 = tmp3_bitMask0 | 1024;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 8;
      tmp41_local36 = tmp46_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 36, tmp47_cached[36], tmp41_local36);
      tmp4_bitMask1 = tmp4_bitMask1 | 16;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 64;
      tmp44_local39 = tmp46_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 39, tmp47_cached[39], tmp44_local39);
      tmp4_bitMask1 = tmp4_bitMask1 | 128;
  ...
  function Companion_20() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30()), new ReferenceArraySerializer(getKClass(Dialogue), $serializer_getInstance_24())];
  }
  ...
  protoOf($serializer_19).serialize_7o3zz9_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 40) ? true : !(value.dialogue == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 40, tmp2_cached[40], value.dialogue);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  protoOf($serializer_19).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp46_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp44_local39 = tmp46_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 39, tmp47_cached[39], tmp44_local39);
      tmp4_bitMask1 = tmp4_bitMask1 | 128;
      tmp45_local40 = tmp46_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 40, tmp47_cached[40], tmp45_local40);
      tmp4_bitMask1 = tmp4_bitMask1 | 256;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp46_input.decodeElementIndex_bstkhp_k$(tmp0_desc);
  ...
  protoOf($serializer_19).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(tmp0_cached[10]), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(tmp0_cached[36]), get_nullable($serializer_getInstance_12()), get_nullable($serializer_getInstance_15()), get_nullable(tmp0_cached[39]), get_nullable(tmp0_cached[40])];
  };
  ...
  function Companion_21() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30()), null, null, null, null, null];
  }
  ...
  protoOf($serializer_20).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp50_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp3_bitMask0 = tmp3_bitMask0 | 512;
      tmp15_local10 = tmp50_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 10, tmp51_cached[10], tmp15_local10);
      tmp3_bitMask0 = tmp3_bitMask0 | 1024;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 8;
      tmp41_local36 = tmp50_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 36, tmp51_cached[36], tmp41_local36);
      tmp4_bitMask1 = tmp4_bitMask1 | 16;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 64;
      tmp44_local39 = tmp50_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 39, tmp51_cached[39], tmp44_local39);
      tmp4_bitMask1 = tmp4_bitMask1 | 128;
  ...
  function Companion_22() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30()), null, null, null, new ReferenceArraySerializer(getKClass(Photo), $serializer_getInstance_25())];
  }
  ...
  protoOf($serializer_21).serialize_oee1fh_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 43) ? true : !(value.photos == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 43, tmp2_cached[43], value.photos);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  protoOf($serializer_21).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp49_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 1024;
      tmp48_local43 = tmp49_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 43, tmp50_cached[43], tmp48_local43);
      tmp4_bitMask1 = tmp4_bitMask1 | 2048;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp49_input.decodeElementIndex_bstkhp_k$(tmp0_desc);
  ...
  protoOf($serializer_21).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(tmp0_cached[10]), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(tmp0_cached[36]), get_nullable($serializer_getInstance_12()), get_nullable($serializer_getInstance_15()), get_nullable(tmp0_cached[39]), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(tmp0_cached[43])];
  };
  ...
  function Companion_23() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30()), null, null];
  }
  ...
  protoOf($serializer_22).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp47_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp3_bitMask0 = tmp3_bitMask0 | 512;
      tmp15_local10 = tmp47_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 10, tmp48_cached[10], tmp15_local10);
      tmp3_bitMask0 = tmp3_bitMask0 | 1024;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 8;
      tmp41_local36 = tmp47_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 36, tmp48_cached[36], tmp41_local36);
      tmp4_bitMask1 = tmp4_bitMask1 | 16;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 64;
      tmp44_local39 = tmp47_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 39, tmp48_cached[39], tmp44_local39);
      tmp4_bitMask1 = tmp4_bitMask1 | 128;
  ...
  function Companion_24() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30())];
  }
  ...
  protoOf($serializer_23).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp45_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp3_bitMask0 = tmp3_bitMask0 | 512;
      tmp15_local10 = tmp45_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 10, tmp46_cached[10], tmp15_local10);
      tmp3_bitMask0 = tmp3_bitMask0 | 1024;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 8;
      tmp41_local36 = tmp45_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 36, tmp46_cached[36], tmp41_local36);
      tmp4_bitMask1 = tmp4_bitMask1 | 16;
      ...
      tmp4_bitMask1 = tmp4_bitMask1 | 64;
      tmp44_local39 = tmp45_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 39, tmp46_cached[39], tmp44_local39);
      tmp4_bitMask1 = tmp4_bitMask1 | 128;
    } else
      while (tmp1_flag) {
  ...
  protoOf($serializer_23).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(tmp0_cached[10]), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(BooleanSerializer_getInstance()), get_nullable(tmp0_cached[36]), get_nullable($serializer_getInstance_12()), get_nullable($serializer_getInstance_15()), get_nullable(tmp0_cached[39])];
  };
  ...
  function Companion_25() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), StringSerializer_getInstance()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ReferenceArraySerializer(getKClass(Note), $serializer_getInstance_10()), null, null, new ReferenceArraySerializer(getKClass(Trail), $serializer_getInstance_30()), null, new ReferenceArraySerializer(getKClass(Video), $serializer_getInstance_27())];
  }
  ...
  protoOf($serializer_24).serialize_yys67u_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 41) ? true : !(value.player == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 41, tmp2_cached[41], value.player);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  protoOf($serializer_24).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp47_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp45_local40 = tmp47_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 40, StringSerializer_getInstance(), tmp45_local40);
      tmp4_bitMask1 = tmp4_bitMask1 | 256;
      tmp46_local41 = tmp47_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 41, tmp48_cached[41], tmp46_local41);
      tmp4_bitMask1 = tmp4_bitMask1 | 512;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp47_input.decodeElementIndex_bstkhp_k$(tmp0_desc);
  ...
  function Companion_27() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, new ReferenceArraySerializer(getKClass(PhotoSize), $serializer_getInstance_26())];
  }
  ...
  protoOf($serializer_26).serialize_8r2rn4_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 2) ? true : !(value.altSizes == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 2, tmp2_cached[2], value.altSizes);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  protoOf($serializer_26).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp7_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
      tmp6_local2 = tmp7_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 2, tmp8_cached[2], tmp6_local2);
      tmp3_bitMask0 = tmp3_bitMask0 | 4;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp7_input.decodeElementIndex_bstkhp_k$(tmp0_desc);
  ...
  protoOf($serializer_26).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(StringSerializer_getInstance()), get_nullable($serializer_getInstance_26()), get_nullable(tmp0_cached[2])];
  };
  ...
  function Companion_34() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.$childSerializers_1 = [null, null, null, null, new ReferenceArraySerializer(getKClass(Blog), $serializer_getInstance_12())];
  }
  ...
  protoOf($serializer_33).serialize_azbyn1_k$ = function (encoder, value) {
    ...
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 4) ? true : !(value.blogs == null)) {
      tmp1_output.encodeNullableSerializableElement_5lquiv_k$(tmp0_desc, 4, tmp2_cached[4], value.blogs);
    }
    tmp1_output.endStructure_1xqz0n_k$(tmp0_desc);
  };
  ...
  protoOf($serializer_33).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (tmp9_input.decodeSequentially_xlblqy_k$()) {
      ...
      tmp3_bitMask0 = tmp3_bitMask0 | 8;
      tmp8_local4 = tmp9_input.decodeNullableSerializableElement_k2y6ab_k$(tmp0_desc, 4, tmp10_cached[4], tmp8_local4);
      tmp3_bitMask0 = tmp3_bitMask0 | 16;
    } else
      while (tmp1_flag) {
        tmp2_index = tmp9_input.decodeElementIndex_bstkhp_k$(tmp0_desc);
  ...
  protoOf($serializer_33).childSerializers_5ghqw5_k$ = function () {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(IntSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(StringSerializer_getInstance()), get_nullable(IntSerializer_getInstance()), get_nullable(tmp0_cached[4])];
  };
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            var tmp0_iterator = this.$files_1.get_entries_p20ztl_k$().iterator_jk1svi_k$();
          ...
          case 2:
            ...
            var containsArg = response.get_status_jnf6d7_k$();
            if (200 <= containsArg ? containsArg <= 299 : false) {
              this.tmp$ret$00__1 = new ResponseUnit(response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              var tmp_1 = this;
              var this_0 = Json_getInstance();
              var obj = response.get_stringBody_otz1zw_k$();
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(AuthOAuth2TokenResponse), arrayOf([]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
            } else {
  ...
  protoOf(AuthResourceImpl).authorizeUrl = function (request) {
    ...
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.internal.AuthResourceImpl.authorizeUrl.<anonymous>' call
    this_0.set_protocol_fzc1gx_k$(Companion_getInstance().get_HTTPS_iai1lu_k$());
    this_0.set_host_sqck4b_k$('www.tumblr.com');
    set_encodedPath(this_0, '/oauth2/authorize');
    // Inline function 'kotlin.apply' call
    var this_1 = this_0.get_parameters_cl4rkd_k$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'work.socialhub.ktumblr.internal.AuthResourceImpl.authorizeUrl.<anonymous>.<anonymous>' call
    ...
    var tmp1_safe_receiver = request.redirectUri;
    if (tmp1_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      this_1.append_rhug0a_k$('redirect_uri', tmp1_safe_receiver);
    }
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(BlogInfoResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            var tmp$ret$0;
            l$ret$1: do {
              var value = r.get_headers_ef25jx_k$().get_wei43m_k$('location');
              if (value == null) {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(BlogLikesResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(BlogFollowingResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(BlogFollowersResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(BlogPostsResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
  ...
  protoOf(BlogResourceImpl).blogLikes = function (request) {
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.apiKeyGet' call
    var path = this.blogPath_po3s0p_k$(ensureNotNull(request.blogName), '/likes');
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(BlogResourceImpl$blogLikes$slambda_0(this, path, params, null));
  };
  protoOf(BlogResourceImpl).blogFollowing = function (request) {
    ...
    var path = this.blogPath_po3s0p_k$(ensureNotNull(request.blogName), '/following');
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(BlogResourceImpl$blogFollowing$slambda_0(this, path, params, null));
  };
  protoOf(BlogResourceImpl).blogFollowers = function (request) {
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.oauthGet' call
    var path = this.blogPath_po3s0p_k$(ensureNotNull(request.blogName), '/followers');
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(BlogResourceImpl$blogFollowers$slambda_0(this, path, params, null));
  };
  protoOf(BlogResourceImpl).blogPosts = function (request) {
    var ext = request.type == null ? '' : '/' + ensureNotNull(request.type);
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.oauthGet' call
    var path = this.blogPath_po3s0p_k$(ensureNotNull(request.blogName), '/posts' + ext);
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(BlogResourceImpl$blogPosts$slambda_0(this, path, params, null));
  };
  protoOf(BlogResourceImpl).blogQueuedPosts = function (request) {
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.oauthGet' call
    var path = this.blogPath_po3s0p_k$(ensureNotNull(request.blogName), '/posts/queue');
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(BlogResourceImpl$blogQueuedPosts$slambda_0(this, path, params, null));
  };
  protoOf(BlogResourceImpl).blogDraftPosts = function (request) {
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.oauthGet' call
    var path = this.blogPath_po3s0p_k$(ensureNotNull(request.blogName), '/posts/draft');
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(BlogResourceImpl$blogDraftPosts$slambda_0(this, path, params, null));
  };
  protoOf(BlogResourceImpl).blogSubmissions = function (request) {
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.oauthGet' call
    var path = this.blogPath_po3s0p_k$(ensureNotNull(request.blogName), '/posts/submission');
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(BlogResourceImpl$blogSubmissions$slambda_0(this, path, params, null));
  };
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(PrimitiveClasses_getInstance().get_arrayClass_udg0fc_k$(), arrayOf([createInvariantKTypeProjection(createKType(getKClass(Post), arrayOf([]), false))]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(UserResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(UserDashboardResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(UserFollowingResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (200 <= containsArg ? containsArg <= 299 : false) {
              ...
              var this_1 = this_0.get_json_woos35_k$();
              var this_2 = this_1.get_serializersModule_piitvg_k$();
              var this_3 = serializer(this_2, createKType(getKClass(Body), arrayOf([createInvariantKTypeProjection(createKType(getKClass(UserLikesResponse), arrayOf([]), false))]), false));
              tmp_1.tmp$ret$00__1 = new Response(this_1.decodeFromString_jwu9sq_k$(isInterface(this_3, KSerializer) ? this_3 : THROW_CCE(), obj), response.get_stringBody_otz1zw_k$());
              this.set_exceptionState_fex74n_k$(6);
              this.set_state_rjd8d0_k$(4);
              continue $sm;
  ...
  protoOf(UserResourceImpl).userDashboard = function (request) {
    ...
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(UserResourceImpl$userDashboard$slambda_0(this, path, params, null));
  };
  protoOf(UserResourceImpl).userFollowing = function (request) {
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.oauthGet' call
    var path = '/user/following';
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(UserResourceImpl$userFollowing$slambda_0(this, path, params, null));
  };
  protoOf(UserResourceImpl).userLikes = function (request) {
    // Inline function 'work.socialhub.ktumblr.internal.AbstractResourceImpl.oauthGet' call
    var path = '/user/likes';
    var params = request.toMap_1tsnvl_k$();
    return runBlocking(UserResourceImpl$userLikes$slambda_0(this, path, params, null));
  };
  ...
  function Json$json$lambda($this$Json) {
    ...
    // Inline function 'work.socialhub.ktumblr.util.Json.json.<anonymous>.<anonymous>' call
  ...
  defineProp(protoOf(Companion), '$cachedDescriptor', protoOf(Companion).get_$cachedDescriptor_3xtnpw_k$);
  ...
  function $jsExportAll$(_) {
    ...
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    defineProp($work$socialhub$ktumblr, 'TumblrFactory', TumblrFactory_getInstance);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response.Body, 'Companion', Companion_getInstance_0);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response.Meta, 'Companion', Companion_getInstance_1);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$auth.AuthOAuth2TokenResponse, 'Companion', Companion_getInstance_2);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$blog.BlogFollowersResponse, 'Companion', Companion_getInstance_3);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$blog.BlogFollowingResponse, 'Companion', Companion_getInstance_4);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$blog.BlogInfoResponse, 'Companion', Companion_getInstance_5);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$blog.BlogLikesResponse, 'Companion', Companion_getInstance_6);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$blog.BlogPostsResponse, 'Companion', Companion_getInstance_7);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$user.UserDashboardResponse, 'Companion', Companion_getInstance_8);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$user.UserFollowingResponse, 'Companion', Companion_getInstance_9);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$user.UserLikesResponse, 'Companion', Companion_getInstance_10);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$api = $work$socialhub$ktumblr.api || ($work$socialhub$ktumblr.api = {});
    ...
    defineProp($work$socialhub$ktumblr$api$response$user.UserResponse, 'Companion', Companion_getInstance_11);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    ...
    defineProp($work$socialhub$ktumblr$define.PhotoType, 'SOURCE', PhotoType_SOURCE_getInstance);
    defineProp($work$socialhub$ktumblr$define.PhotoType, 'FILE', PhotoType_FILE_getInstance);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$define = $work$socialhub$ktumblr.define || ($work$socialhub$ktumblr.define = {});
    ...
    defineProp($work$socialhub$ktumblr$define.PostType, 'TEXT', PostType_TEXT_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'PHOTO', PostType_PHOTO_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'QUOTE', PostType_QUOTE_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'LINK', PostType_LINK_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'CHAT', PostType_CHAT_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'AUDIO', PostType_AUDIO_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'VIDEO', PostType_VIDEO_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'ANSWER', PostType_ANSWER_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'POSTCARD', PostType_POSTCARD_getInstance);
    defineProp($work$socialhub$ktumblr$define.PostType, 'UNKNOWN', PostType_UNKNOWN_getInstance);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    ...
    defineProp($work$socialhub$ktumblr$entity.Note, 'Companion', Companion_getInstance_12);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    $work$socialhub$ktumblr$entity.NoteAvatar = NoteAvatar;
    defineProp($work$socialhub$ktumblr$entity.NoteAvatar, 'Companion', Companion_getInstance_13);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$blog.Blog, 'Companion', Companion_getInstance_14);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$blog.BlogAvatar, 'Companion', Companion_getInstance_15);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$blog.BlogTheme, 'Companion', Companion_getInstance_16);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$blog.Reblog, 'Companion', Companion_getInstance_17);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post.Post, 'Companion', Companion_getInstance_18);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$legacy.LegacyAnswerPost, 'Companion', Companion_getInstance_19);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$legacy.LegacyAudioPost, 'Companion', Companion_getInstance_20);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$legacy.LegacyChatPost, 'Companion', Companion_getInstance_21);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$legacy.LegacyLinkPost, 'Companion', Companion_getInstance_22);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$legacy.LegacyPhotoPost, 'Companion', Companion_getInstance_23);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$legacy.LegacyQuotePost, 'Companion', Companion_getInstance_24);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$legacy.LegacyVideoPost, 'Companion', Companion_getInstance_26);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$options.Dialogue, 'Companion', Companion_getInstance_27);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$options.Photo, 'Companion', Companion_getInstance_28);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$options.PhotoSize, 'Companion', Companion_getInstance_29);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$post$options.Video, 'Companion', Companion_getInstance_30);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$trail.BlogInTrail, 'Companion', Companion_getInstance_31);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$trail.IdInTrail, 'Companion', Companion_getInstance_32);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$trail.Trail, 'Companion', Companion_getInstance_33);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$user.FollowerUser, 'Companion', Companion_getInstance_34);
    var $work = _.work || (_.work = {});
    var $work$socialhub = $work.socialhub || ($work.socialhub = {});
    var $work$socialhub$ktumblr = $work$socialhub.ktumblr || ($work$socialhub.ktumblr = {});
    var $work$socialhub$ktumblr$entity = $work$socialhub$ktumblr.entity || ($work$socialhub$ktumblr.entity = {});
    ...
    defineProp($work$socialhub$ktumblr$entity$user.User, 'Companion', Companion_getInstance_35);
  }
  $jsExportAll$(_);
