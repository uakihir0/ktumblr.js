(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './ktor-ktor-utils.js', './kotlinx-coroutines-core.js', './kotlin-kotlin-stdlib.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./ktor-ktor-utils.js'), require('./kotlinx-coroutines-core.js'), require('./kotlin-kotlin-stdlib.js'));
  else {
    ...
    globalThis['ktor-ktor-events'] = factory(typeof globalThis['ktor-ktor-events'] === 'undefined' ? {} : globalThis['ktor-ktor-events'], globalThis['ktor-ktor-utils'], globalThis['kotlinx-coroutines-core'], globalThis['kotlin-kotlin-stdlib']);
  }
  ...
  function Events() {
    this.g2t_1 = new CopyOnWriteHashMap();
  }
  protoOf(Events).h2t = function (definition, value) {
    var exception = null;
    var tmp0_safe_receiver = this.g2t_1.q29(definition);
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'io.ktor.util.internal.LockFreeLinkedListHead.forEach' call
      var tmp = tmp0_safe_receiver.k1l();
      var cur = tmp instanceof LockFreeLinkedListNode ? tmp : THROW_CCE();
      while (!equals(cur, tmp0_safe_receiver)) {
        if (cur instanceof HandlerRegistration) {
          var registration = cur;
          try {
            var tmp_0 = registration.j2t_1;
