(function (factory) {
  ...
  var _ChannelResult___get_isClosed__impl__mg7kuu = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.r;
  ...
  var cancel$default_0 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.n;
  var Channel_0 = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.v;
  var RuntimeException = kotlin_kotlin.$_$.xi;
  var RuntimeException_init_$Init$ = kotlin_kotlin.$_$.k3;
  ...
  var substring = kotlin_kotlin.$_$.fh;
            ...
            if (tmp_0 instanceof ClosedSendChannelException) {
              ...
              if (tmp_1 instanceof ClosedReceiveChannelException) {
                ...
                if (tmp_2 instanceof CancellationException) {
                  ...
                  this.set_state_rjd8d0_k$(5);
                  suspendResult = sendCloseSequence(this.this$0__1, CloseReason_init_$Create$(Codes_NORMAL_getInstance(), ''), VOID, this);
                  if (suspendResult === get_COROUTINE_SUSPENDED()) {
                    return suspendResult;
                  }
                  continue $sm;
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (frame instanceof Close) {
              this.set_state_rjd8d0_k$(3);
              suspendResult = sendCloseSequence(this._this__u8e3s4__1, readReason(frame), VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
  ...
  protoOf(DefaultWebSocketSessionImpl).start_ye6294_k$ = function (negotiatedExtensions) {
    ...
    if (get_isTraceEnabled(this_0)) {
      ...
      this_0.trace_fti9bv_k$(tmp$ret$2);
    }
  ...
  protoOf(DefaultWebSocketSessionImpl).goingAway_j5stwl_k$ = function (message, $completion) {
    return sendCloseSequence(this, CloseReason_init_$Create$(Codes_GOING_AWAY_getInstance(), message), VOID, $completion);
  };
  ...
  protoOf(BoundedChannel).trySend_62dpg8_k$ = function (element) {
    return this.trySend_w1juo7_k$(element);
  };
  ...
  protoOf(BoundedChannel).send_44jogj_k$ = function (element, $completion) {
    return this.send_7nf3lq_k$(element, $completion);
  };
  ...
  protoOf(BoundedChannel).offer_uqgnr2_k$ = function (element) {
    return this.offer_szb1l9_k$(element);
  };
  ...
  protoOf(Frame).copy_1tks5_k$ = function () {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    var tmp$ret$0 = this.data_1.slice();
    return tmp.byType_90xas5_k$(this.fin_1, this.frameType_1, tmp$ret$0, this.rsv1__1, this.rsv2__1, this.rsv3__1);
  };
  ...
  _.$_$.e = send;
  _.$_$.f = start$default;
  _.$_$.g = Binary_init_$Create$;
  _.$_$.h = Close_init_$Create$;
  _.$_$.i = Text_init_$Create$_0;
  _.$_$.j = CloseReason;
