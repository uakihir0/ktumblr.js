(function (factory) {
  ...
  var UnsafeByteStringOperations_getInstance = kotlin_org_jetbrains_kotlinx_kotlinx_io_bytestring.$_$.a;
  ...
  var IllegalArgumentException_init_$Create$_0 = kotlin_kotlin.$_$.t2;
  ...
  var StringBuilder_init_$Create$_0 = kotlin_kotlin.$_$.i2;
  ...
  var Exception_init_$Init$_0 = kotlin_kotlin.$_$.o2;
  var Exception_init_$Init$_1 = kotlin_kotlin.$_$.m2;
  var Exception_init_$Init$_2 = kotlin_kotlin.$_$.q2;
  var Exception = kotlin_kotlin.$_$.qi;
  var KProperty0 = kotlin_kotlin.$_$.xe;
  var getPropertyCallableRef = kotlin_kotlin.$_$.uc;
  var UnsupportedOperationException_init_$Create$ = kotlin_kotlin.$_$.q3;
  ...
  function pushSegment($this, newTail, tryCompact) {
    tryCompact = tryCompact === VOID ? false : tryCompact;
    if ($this.head_1 == null) {
      $this.head_1 = newTail;
      $this.tail_1 = newTail;
    } else if (tryCompact) {
  ...
  protoOf(Buffer).toString = function () {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.get_size_woubt6_k$()) {
        ...
        var tmp$ret$4 = b_0 >> 4;
        var tmp_0 = builder.append_am5a4z_k$(tmp[tmp$ret$4 & 15]);
        var tmp_1 = get_HEX_DIGIT_CHARS();
        // Inline function 'kotlinx.io.and' call
        var tmp$ret$5 = b_0 & 15;
        tmp_0.append_am5a4z_k$(tmp_1[tmp$ret$5]);
      }
      ...
      if (c < 128) {
        ...
        $l$block_0: {
          ...
          if (bytesWritten === 1) {
            ...
            var tmp$ret$11 = add(this_3, fromInt(bytesWritten));
          ...
          if (!(bytesWritten === 0)) {
            ...
            var tmp$ret$14 = add(this_4, fromInt(bytesWritten));
            this_0.set_sizeMut_cp56bw_k$(tmp$ret$14);
            break $l$block_0;
          }
          if (isEmpty(tail)) {
        ...
        $l$block_2: {
          ...
          if (bytesWritten_0 === 2) {
            ...
            var tmp$ret$17 = add(this_5, fromInt(bytesWritten_0));
          ...
          if (!(bytesWritten_0 === 0)) {
            ...
            var tmp$ret$20 = add(this_6, fromInt(bytesWritten_0));
        ...
        $l$block_4: {
          ...
          if (bytesWritten_1 === 3) {
            ...
            var tmp$ret$23 = add(this_7, fromInt(bytesWritten_1));
          ...
          if (!(bytesWritten_1 === 0)) {
            ...
            var tmp$ret$26 = add(this_8, fromInt(bytesWritten_1));
            this_0.set_sizeMut_cp56bw_k$(tmp$ret$26);
            break $l$block_4;
          }
          if (isEmpty(tail_1)) {
            this_0.recycleTail_61sxi3_k$();
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          this_0.writeByte_9ih3z3_k$(toByte(tmp$ret$29));
          i = i + 1 | 0;
        } else {
          ...
          $l$block_6: {
            ...
            if (bytesWritten_2 === 4) {
              ...
              var tmp$ret$32 = add(this_11, fromInt(bytesWritten_2));
            ...
            if (!(bytesWritten_2 === 0)) {
              ...
              var tmp$ret$35 = add(this_12, fromInt(bytesWritten_2));
              this_0.set_sizeMut_cp56bw_k$(tmp$ret$35);
              break $l$block_6;
            }
            if (isEmpty(tail_2)) {
              this_0.recycleTail_61sxi3_k$();
      ...
      if (c < 128) {
        ...
        $l$block_0: {
          ...
          if (bytesWritten === 1) {
            ...
            var tmp$ret$5 = add(this_2, fromInt(bytesWritten));
            _this__u8e3s4.set_sizeMut_cp56bw_k$(tmp$ret$5);
            break $l$block_0;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten ? bytesWritten <= tail.get_remainingCapacity_c94947_k$() : false)) {
        ...
        $l$block_2: {
          ...
          if (bytesWritten_0 === 2) {
            ...
            var tmp$ret$11 = add(this_4, fromInt(bytesWritten_0));
            _this__u8e3s4.set_sizeMut_cp56bw_k$(tmp$ret$11);
            break $l$block_2;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.get_remainingCapacity_c94947_k$() : false)) {
        ...
        $l$block_4: {
          ...
          if (bytesWritten_1 === 3) {
            ...
            var tmp$ret$17 = add(this_6, fromInt(bytesWritten_1));
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          $l$block_6: {
            ...
            if (bytesWritten_2 === 4) {
              ...
              var tmp$ret$25 = add(this_10, fromInt(bytesWritten_2));
              _this__u8e3s4.set_sizeMut_cp56bw_k$(tmp$ret$25);
              break $l$block_6;
            }
            // Inline function 'kotlin.check' call
            if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.get_remainingCapacity_c94947_k$() : false)) {
