(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['ktumblr-core'] === 'undefined') {
    ...
    root['work.socialhub.ktumblr:all'] = factory(typeof this['work.socialhub.ktumblr:all'] === 'undefined' ? {} : this['work.socialhub.ktumblr:all'], this['ktumblr-core'], this['kotlin-kotlin-stdlib']);
  }
}(globalThis, function (_, kotlin_work_socialhub_ktumblr_core, kotlin_kotlin) {
  'use strict';
