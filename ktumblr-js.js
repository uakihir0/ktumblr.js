(function (factory) {
  ...
  protoOf(KtumblrFactory).d4v = function (clientId, clientSecret, accessToken, refreshToken) {
  ...
  //region block: init
  KtumblrFactory_instance = new KtumblrFactory();
  //endregion
  ...
  function $jsExportAll$(_) {
    ...
    defineProp(ktumblr, 'KtumblrFactory', KtumblrFactory_getInstance, VOID, true);
  }
  $jsExportAll$(_);
