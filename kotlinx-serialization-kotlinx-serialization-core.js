(function (factory) {
  ...
  var Annotation = kotlin_kotlin.$_$.fi;
  ...
  var StringCompanionObject_getInstance = kotlin_kotlin.$_$.n;
  ...
  var IllegalArgumentException_init_$Init$_1 = kotlin_kotlin.$_$.w2;
  var IllegalArgumentException_init_$Init$_2 = kotlin_kotlin.$_$.r2;
  ...
  var KClass = kotlin_kotlin.$_$.ue;
  var Triple = kotlin_kotlin.$_$.aj;
  var Pair = kotlin_kotlin.$_$.vi;
  var Entry = kotlin_kotlin.$_$.g6;
  var KtMutableMap = kotlin_kotlin.$_$.n6;
  var LinkedHashMap = kotlin_kotlin.$_$.d6;
  var HashMap = kotlin_kotlin.$_$.z5;
  var KtSet = kotlin_kotlin.$_$.p6;
  var KtMutableSet = kotlin_kotlin.$_$.o6;
  var LinkedHashSet = kotlin_kotlin.$_$.e6;
  ...
  var Duration__toIsoString_impl_9h6wsm = kotlin_kotlin.$_$.w3;
  var Duration = kotlin_kotlin.$_$.ai;
  var Companion_getInstance = kotlin_kotlin.$_$.t;
  var Instant = kotlin_kotlin.$_$.bi;
  var Companion_getInstance_0 = kotlin_kotlin.$_$.u;
  var Uuid = kotlin_kotlin.$_$.ei;
  var Companion_getInstance_1 = kotlin_kotlin.$_$.v;
  var toIntOrNull = kotlin_kotlin.$_$.nh;
  var hashCode = kotlin_kotlin.$_$.wc;
  var isArray = kotlin_kotlin.$_$.ed;
  var arrayIterator = kotlin_kotlin.$_$.gc;
  var ArrayList_init_$Create$_1 = kotlin_kotlin.$_$.o1;
  var HashSet_init_$Create$_0 = kotlin_kotlin.$_$.u1;
  var LinkedHashSet_init_$Create$ = kotlin_kotlin.$_$.z1;
  var LinkedHashSet_init_$Create$_0 = kotlin_kotlin.$_$.a2;
  var HashMap_init_$Create$ = kotlin_kotlin.$_$.q1;
  var HashMap_init_$Create$_0 = kotlin_kotlin.$_$.r1;
  var LinkedHashMap_init_$Create$_1 = kotlin_kotlin.$_$.x1;
  var until = kotlin_kotlin.$_$.ne;
  var step = kotlin_kotlin.$_$.me;
  var getValue = kotlin_kotlin.$_$.h8;
  var longArray = kotlin_kotlin.$_$.sd;
  var get_lastIndex = kotlin_kotlin.$_$.p8;
  var shiftLeft = kotlin_kotlin.$_$.zb;
  var bitwiseOr = kotlin_kotlin.$_$.jb;
  var equalsLong = kotlin_kotlin.$_$.qb;
  var invert = kotlin_kotlin.$_$.sb;
  var countTrailingZeroBits = kotlin_kotlin.$_$.oj;
  var indexOf = kotlin_kotlin.$_$.i8;
  var contentToString = kotlin_kotlin.$_$.i7;
  var Enum = kotlin_kotlin.$_$.oi;
  var joinToString = kotlin_kotlin.$_$.m8;
  var toString_0 = kotlin_kotlin.$_$.bk;
  var KTypeParameter = kotlin_kotlin.$_$.af;
  var HashSet_init_$Create$_1 = kotlin_kotlin.$_$.s1;
  var booleanArray = kotlin_kotlin.$_$.hc;
  var emptyMap = kotlin_kotlin.$_$.y7;
  var contentHashCode = kotlin_kotlin.$_$.h7;
  var Companion_getInstance_2 = kotlin_kotlin.$_$.w;
  var isCharArray = kotlin_kotlin.$_$.hd;
  var charArray = kotlin_kotlin.$_$.kc;
  var DoubleCompanionObject_getInstance = kotlin_kotlin.$_$.j;
  var isDoubleArray = kotlin_kotlin.$_$.jd;
  var FloatCompanionObject_getInstance = kotlin_kotlin.$_$.k;
  var isFloatArray = kotlin_kotlin.$_$.kd;
  var Companion_getInstance_3 = kotlin_kotlin.$_$.x;
  var isLongArray = kotlin_kotlin.$_$.tb;
  var Companion_getInstance_4 = kotlin_kotlin.$_$.b1;
  var _ULongArray___get_size__impl__ju6dtr = kotlin_kotlin.$_$.j5;
  var ULongArray = kotlin_kotlin.$_$.fj;
  var _ULongArray___init__impl__twm1l3 = kotlin_kotlin.$_$.f5;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.c5;
  var ULongArray__get_impl_pr71q9 = kotlin_kotlin.$_$.h5;
  var _ULong___get_data__impl__fggpzb = kotlin_kotlin.$_$.d5;
  var IntCompanionObject_getInstance = kotlin_kotlin.$_$.l;
  var isIntArray = kotlin_kotlin.$_$.ld;
  var Companion_getInstance_5 = kotlin_kotlin.$_$.a1;
  var _UIntArray___get_size__impl__r6l8ci = kotlin_kotlin.$_$.a5;
  var UIntArray = kotlin_kotlin.$_$.dj;
  var _UIntArray___init__impl__ghjpc6 = kotlin_kotlin.$_$.w4;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.t4;
  var UIntArray__get_impl_gp5kza = kotlin_kotlin.$_$.y4;
  var _UInt___get_data__impl__f0vqqw = kotlin_kotlin.$_$.u4;
  var ShortCompanionObject_getInstance = kotlin_kotlin.$_$.m;
  var isShortArray = kotlin_kotlin.$_$.od;
  var Companion_getInstance_6 = kotlin_kotlin.$_$.c1;
  var _UShortArray___get_size__impl__jqto1b = kotlin_kotlin.$_$.s5;
  var UShortArray = kotlin_kotlin.$_$.hj;
  var _UShortArray___init__impl__9b26ef = kotlin_kotlin.$_$.o5;
  var _UShort___init__impl__jigrne = kotlin_kotlin.$_$.l5;
  var UShortArray__get_impl_fnbhmx = kotlin_kotlin.$_$.q5;
  var _UShort___get_data__impl__g0245 = kotlin_kotlin.$_$.m5;
  var ByteCompanionObject_getInstance = kotlin_kotlin.$_$.i;
  var isByteArray = kotlin_kotlin.$_$.gd;
  var Companion_getInstance_7 = kotlin_kotlin.$_$.z;
  var _UByteArray___get_size__impl__h6pkdv = kotlin_kotlin.$_$.r4;
  var UByteArray = kotlin_kotlin.$_$.bj;
  var _UByteArray___init__impl__ip4y9n = kotlin_kotlin.$_$.o4;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.k4;
  var UByteArray__get_impl_t5f3hv = kotlin_kotlin.$_$.p4;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.l4;
  var BooleanCompanionObject_getInstance = kotlin_kotlin.$_$.h;
  var isBooleanArray = kotlin_kotlin.$_$.fd;
  var coerceAtLeast = kotlin_kotlin.$_$.ie;
  var copyOf = kotlin_kotlin.$_$.n7;
  var copyOf_0 = kotlin_kotlin.$_$.p7;
  var copyOf_1 = kotlin_kotlin.$_$.q7;
  var copyOf_2 = kotlin_kotlin.$_$.l7;
  var _ULongArray___get_storage__impl__28e64j = kotlin_kotlin.$_$.k5;
  var _ULongArray___init__impl__twm1l3_0 = kotlin_kotlin.$_$.g5;
  var ULongArray__set_impl_z19mvh = kotlin_kotlin.$_$.i5;
  var copyOf_3 = kotlin_kotlin.$_$.s7;
  var _UIntArray___get_storage__impl__92a0v0 = kotlin_kotlin.$_$.b5;
  var _UIntArray___init__impl__ghjpc6_0 = kotlin_kotlin.$_$.x4;
  var UIntArray__set_impl_7f2zu2 = kotlin_kotlin.$_$.z4;
  var copyOf_4 = kotlin_kotlin.$_$.k7;
  var _UShortArray___get_storage__impl__t2jpv5 = kotlin_kotlin.$_$.t5;
  var _UShortArray___init__impl__9b26ef_0 = kotlin_kotlin.$_$.p5;
  var UShortArray__set_impl_6d8whp = kotlin_kotlin.$_$.r5;
  var copyOf_5 = kotlin_kotlin.$_$.o7;
  var _UByteArray___get_storage__impl__d4kctt = kotlin_kotlin.$_$.s4;
  var _UByteArray___init__impl__ip4y9n_0 = kotlin_kotlin.$_$.n4;
  var UByteArray__set_impl_jvcicn = kotlin_kotlin.$_$.q4;
  var copyOf_6 = kotlin_kotlin.$_$.m7;
  var trimIndent = kotlin_kotlin.$_$.xh;
  var Unit = kotlin_kotlin.$_$.jj;
  ...
  var ULong = kotlin_kotlin.$_$.gj;
  var UInt = kotlin_kotlin.$_$.ej;
  var UByte = kotlin_kotlin.$_$.cj;
  var UShort = kotlin_kotlin.$_$.ij;
  var noWhenBranchMatchedException = kotlin_kotlin.$_$.xj;
  var asSequence = kotlin_kotlin.$_$.x6;
  var nextAssociatedObjectId = kotlin_kotlin.$_$.vd;
  var get_js = kotlin_kotlin.$_$.qd;
  ...
  var IndexOutOfBoundsException_init_$Create$ = kotlin_kotlin.$_$.d3;
  var get_indices_0 = kotlin_kotlin.$_$.j8;
  var get_longArrayClass = kotlin_kotlin.$_$.ub;
  var mapOf = kotlin_kotlin.$_$.w8;
  var Companion_getInstance_8 = kotlin_kotlin.$_$.y;
  ...
  initMetadataForClass(elementNames$1, VOID, VOID, VOID, [Iterator]);
  initMetadataForClass(elementNames$$inlined$Iterable$1, VOID, VOID, VOID, [Iterable]);
  ...
  function PolymorphicSerializer$descriptor$delegate$lambda$lambda(this$0) {
    return function ($this$buildSerialDescriptor) {
      $this$buildSerialDescriptor.element$default_ey7ac9_k$('type', serializer_1(StringCompanionObject_getInstance()).get_descriptor_wjt6a0_k$());
  ...
  protoOf(SealedClassSerializer$$inlined$groupingBy$1).keyOf_d1fr09_k$ = function (element) {
    return this.keyOf_qdhuon_k$(element);
  };
  function SealedClassSerializer(serialName, baseClass, subclasses, subclassSerializers) {
    ...
    while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
      ...
      var tmp$ret$12 = element.get_value_j01efc_k$().get_value_j01efc_k$();
      destination_0.put_4fpzoq_k$(tmp_2, tmp$ret$12);
    }
  ...
  protoOf(SealedClassSerializer).get_class2Serializer_qbcxt5_k$ = function () {
  ...
  function MissingFieldException_init_$Init$(missingFields, serialName, $this) {
    var tmp0_message = missingFields.get_size_woubt6_k$() === 1 ? "Field '" + missingFields.get_c1px32_k$(0) + "' is required for type with serial name '" + serialName + "', but it was missing" : 'Fields ' + toString(missingFields) + " are required for type with serial name '" + serialName + "', but they were missing";
  ...
  function MissingFieldException_init_$Init$_0(missingField, serialName, $this) {
    var tmp0_missingFields = listOf(missingField);
    var tmp1_message = "Field '" + missingField + "' is required for type with serial name '" + serialName + "', but it was missing";
    MissingFieldException.call($this, tmp1_message, null, tmp0_missingFields, serialName);
    return $this;
  }
  ...
  function MissingFieldException_init_$Init$_1(missingFields, message, cause, $this) {
    MissingFieldException.call($this, message, cause, missingFields, null);
    return $this;
  }
  function MissingFieldException_init_$Create$_1(missingFields, message, cause) {
    var tmp = MissingFieldException_init_$Init$_1(missingFields, message, cause, objectCreate(protoOf(MissingFieldException)));
    captureStack(tmp, MissingFieldException_init_$Create$_1);
    return tmp;
  }
  function MissingFieldException_init_$Init$_2(missingField, $this) {
    MissingFieldException.call($this, "Field '" + missingField + "' is required, but it was missing", null, listOf(missingField), null);
    return $this;
  }
  function MissingFieldException_init_$Create$_2(missingField) {
    var tmp = MissingFieldException_init_$Init$_2(missingField, objectCreate(protoOf(MissingFieldException)));
    captureStack(tmp, MissingFieldException_init_$Create$_2);
    return tmp;
  }
  ...
  protoOf(MissingFieldException).get_serialName_u2rqhk_k$ = function () {
    return this.serialName_1;
  };
  protoOf(MissingFieldException).withNewMessageInternal_ocnlki_k$ = function (newMessage) {
    return new MissingFieldException(newMessage, this, this.missingFields_1, this.serialName_1);
  };
  ...
  protoOf(elementNames$1).hasNext_bitz1p_k$ = function () {
    return this.elementsLeft_1 > 0;
  };
  protoOf(elementNames$1).next_20eer_k$ = function () {
  ...
  protoOf(elementNames$$inlined$Iterable$1).iterator_jk1svi_k$ = function () {
  ...
  function SerialDescriptorImpl(serialName, kind, elementsCount, typeParameters, builder) {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var item = _iterator__ex2g4s.next_20eer_k$();
      var tmp$ret$4 = to(item.get_value_j01efc_k$(), item.get_index_it478p_k$());
  ...
  function InstantSerializer() {
    ...
    this.descriptor_1 = new PrimitiveSerialDescriptor_0('kotlin.time.Instant', STRING_getInstance());
  }
  protoOf(InstantSerializer).get_descriptor_wjt6a0_k$ = function () {
    return this.descriptor_1;
  };
  protoOf(InstantSerializer).serialize_cfo280_k$ = function (encoder, value) {
    encoder.encodeString_424b5v_k$(value.toString());
  };
  protoOf(InstantSerializer).serialize_5ase3y_k$ = function (encoder, value) {
    return this.serialize_cfo280_k$(encoder, value instanceof Instant ? value : THROW_CCE());
  };
  protoOf(InstantSerializer).deserialize_sy6x50_k$ = function (decoder) {
    return Companion_getInstance_0().parse_xovy9i_k$(decoder.decodeString_x3hxsx_k$());
  };
  ...
  protoOf(ReferenceArraySerializer).insert_rt7dry_k$ = function (_this__u8e3s4, index, element) {
    return this.insert_4w10q6_k$(_this__u8e3s4 instanceof ArrayList ? _this__u8e3s4 : THROW_CCE(), index, element);
  };
  ...
  protoOf(ArrayListSerializer).insert_rt7dry_k$ = function (_this__u8e3s4, index, element) {
    return this.insert_irgt39_k$(_this__u8e3s4 instanceof ArrayList ? _this__u8e3s4 : THROW_CCE(), index, element);
  };
  ...
  protoOf(HashMapSerializer).insertKeyValuePair_1auocl_k$ = function (_this__u8e3s4, index, key, value) {
    return this.insertKeyValuePair_ddw0oi_k$(_this__u8e3s4 instanceof HashMap ? _this__u8e3s4 : THROW_CCE(), index, key, value);
  };
  ...
  protoOf(LinkedHashMapSerializer).insertKeyValuePair_1auocl_k$ = function (_this__u8e3s4, index, key, value) {
    return this.insertKeyValuePair_myfi4h_k$(_this__u8e3s4 instanceof LinkedHashMap ? _this__u8e3s4 : THROW_CCE(), index, key, value);
  };
  ...
  protoOf(PrimitiveArrayBuilder).ensureCapacity$default_4tzhe_k$ = function (requiredCapacity, $super) {
  ...
  function markHigh($this, index) {
    ...
    $this.highMarksArray_1[slot] = bitwiseOr($this.highMarksArray_1[slot], shiftLeft(new Long(1, 0), offsetInSlot));
  }
  ...
  function ElementMarker(descriptor, readIfAbsent) {
    ...
    if (elementsCount <= 64) {
      ...
      this.highMarksArray_1 = Companion_getInstance_10().EMPTY_HIGH_MARKS_1;
    } else {
  ...
  protoOf(ElementMarker).mark_qmjjl1_k$ = function (index) {
    if (index < 64) {
      this.lowerMarks_1 = bitwiseOr(this.lowerMarks_1, shiftLeft(new Long(1, 0), index));
    } else {
      markHigh(this, index);
    }
  };
  protoOf(ElementMarker).nextUnmarkedIndex_u6mxd2_k$ = function () {
    var elementsCount = this.descriptor_1.get_elementsCount_288r0x_k$();
    while (!equalsLong(this.lowerMarks_1, new Long(-1, -1))) {
      var index = countTrailingZeroBits(invert(this.lowerMarks_1));
      this.lowerMarks_1 = bitwiseOr(this.lowerMarks_1, shiftLeft(new Long(1, 0), index));
      if (this.readIfAbsent_1(this.descriptor_1, index)) {
        return index;
      }
  ...
  protoOf(EnumSerializer).serialize_dc42ix_k$ = function (encoder, value) {
    ...
    if (index === -1) {
      throw SerializationException_init_$Create$_0(toString(value) + ' is not a valid enum ' + this.get_descriptor_wjt6a0_k$().get_serialName_u2rqhk_k$() + ', ' + ('must be one of ' + contentToString(this.values_1)));
    }
  ...
  function EnumDescriptor$_get_elementDescriptors_$ref_5lvk4a() {
    return function (p0) {
      return _get_elementDescriptors__y23q9p_0(p0);
    };
  }
  ...
  function missingFieldExceptionWithNewMessage(exception, message) {
    return exception.withNewMessageInternal_ocnlki_k$(message);
  }
  ...
  function toStringImpl$lambda($this_toStringImpl) {
    return function (i) {
      return $this_toStringImpl.getElementName_u4sqmf_k$(i) + ': ' + $this_toStringImpl.getElementDescriptor_ncda77_k$(i).get_serialName_u2rqhk_k$();
    };
  }
  ...
  function DoubleArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_11(DoubleCompanionObject_getInstance()));
  }
  ...
  function FloatArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_12(FloatCompanionObject_getInstance()));
  }
  ...
  protoOf(MapEntry).equals = function (other) {
    ...
    if (!(other instanceof MapEntry))
      return false;
    if (!equals(this.key_1, other.key_1))
      return false;
  ...
  function ULongSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.ULong', serializer_6(Companion_getInstance_3()));
  }
  ...
  function UByteSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.UByte', serializer_8(ByteCompanionObject_getInstance()));
  }
  ...
  protoOf(SerialModuleImpl).dumpTo_vt5sm4_k$ = function (collector) {
    ...
    while (_iterator__ex2g4s_0.hasNext_bitz1p_k$()) {
      ...
      while (_iterator__ex2g4s_1.hasNext_bitz1p_k$()) {
        ...
        collector.polymorphic_74dxah_k$(tmp_1, tmp_2, tmp$ret$15);
      }
    }
    // Inline function 'kotlin.collections.forEach' call
    // Inline function 'kotlin.collections.iterator' call
  ...
  protoOf(SerializersModuleBuilder).contextual_s0h8js_k$ = function (kClass, serializer) {
    return this.registerSerializer$default_6crdmw_k$(kClass, new Argless(serializer));
  };
  protoOf(SerializersModuleBuilder).contextual_lh3eph_k$ = function (kClass, provider) {
    return this.registerSerializer$default_6crdmw_k$(kClass, new WithTypeArguments(provider));
  };
  protoOf(SerializersModuleBuilder).polymorphic_74dxah_k$ = function (baseClass, actualClass, actualSerializer) {
    this.registerPolymorphicSerializer$default_xvggxd_k$(baseClass, actualClass, actualSerializer);
  };
  ...
  protoOf(SerializersModuleBuilder).registerSerializer$default_6crdmw_k$ = function (forClass, provider, allowOverwrite, $super) {
  ...
  protoOf(SerializersModuleBuilder).registerPolymorphicSerializer_xsbrkt_k$ = function (baseClass, concreteClass, concreteSerializer, allowOverwrite) {
    ...
    if (!(previousByName == null) && !equals(previousByName, concreteSerializer)) {
      ...
      if (allowOverwrite)
        baseClassSerializers.remove_gppy8k_k$(previousClass);
      else
  ...
  protoOf(SerializersModuleBuilder).registerPolymorphicSerializer$default_xvggxd_k$ = function (baseClass, concreteClass, concreteSerializer, allowOverwrite, $super) {
    allowOverwrite = allowOverwrite === VOID ? false : allowOverwrite;
    var tmp;
    if ($super === VOID) {
  ...
  function initBuiltins() {
    return mapOf([to(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), serializer_1(StringCompanionObject_getInstance())), to(getKClass(Char), serializer_10(Companion_getInstance_2())), to(PrimitiveClasses_getInstance().get_charArrayClass_7lhfoe_k$(), CharArraySerializer()), to(PrimitiveClasses_getInstance().get_doubleClass_dahzcy_k$(), serializer_11(DoubleCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_doubleArrayClass_84hee1_k$(), DoubleArraySerializer()), to(PrimitiveClasses_getInstance().get_floatClass_xlwq2t_k$(), serializer_12(FloatCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_floatArrayClass_qngmha_k$(), FloatArraySerializer()), to(getKClass(Long), serializer_6(Companion_getInstance_3())), to(get_longArrayClass(), LongArraySerializer()), to(getKClass(ULong), serializer_2(Companion_getInstance_4())), to(getKClass(ULongArray), ULongArraySerializer()), to(PrimitiveClasses_getInstance().get_intClass_mw4y9a_k$(), serializer_7(IntCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_intArrayClass_h44pbv_k$(), IntArraySerializer()), to(getKClass(UInt), serializer_3(Companion_getInstance_5())), to(getKClass(UIntArray), UIntArraySerializer()), to(PrimitiveClasses_getInstance().get_shortClass_5ajsv9_k$(), serializer_9(ShortCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_shortArrayClass_c1p7wy_k$(), ShortArraySerializer()), to(getKClass(UShort), serializer_5(Companion_getInstance_6())), to(getKClass(UShortArray), UShortArraySerializer()), to(PrimitiveClasses_getInstance().get_byteClass_pu7s61_k$(), serializer_8(ByteCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_byteArrayClass_57my8g_k$(), ByteArraySerializer()), to(getKClass(UByte), serializer_4(Companion_getInstance_7())), to(getKClass(UByteArray), UByteArraySerializer()), to(PrimitiveClasses_getInstance().get_booleanClass_d285fr_k$(), serializer_13(BooleanCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_booleanArrayClass_lnbwea_k$(), BooleanArraySerializer()), to(getKClass(Unit), serializer_14(Unit_getInstance())), to(PrimitiveClasses_getInstance().get_nothingClass_7ivpcc_k$(), NothingSerializer()), to(getKClass(Duration), serializer_15(Companion_getInstance())), to(getKClass(Instant), serializer_16(Companion_getInstance_0())), to(getKClass(Uuid), serializer_17(Companion_getInstance_1()))]);
  }
  ...
  _.$_$.m = MissingFieldException_init_$Create$_0;
  _.$_$.n = SerializationException_init_$Init$_0;
  _.$_$.o = SerializationException_init_$Create$_0;
  _.$_$.p = UnknownFieldException_init_$Create$;
