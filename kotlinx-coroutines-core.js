(function (factory) {
  ...
  var Key_getInstance = kotlin_kotlin.$_$.s4;
  ...
  var addSuppressed = kotlin_kotlin.$_$.fj;
  ...
  var Error_0 = kotlin_kotlin.$_$.ji;
  ...
  var NoSuchElementException = kotlin_kotlin.$_$.oi;
  ...
  var throwKotlinNothingValueException = kotlin_kotlin.$_$.uj;
  ...
  initMetadataForInterface(ChildJob, 'ChildJob', VOID, VOID, [Job_0], [0]);
  initMetadataForInterface(ParentJob, 'ParentJob', VOID, VOID, [Job_0], [0]);
  initMetadataForClass(JobSupport, 'JobSupport', VOID, VOID, [Job_0, ChildJob, ParentJob], [0]);
  ...
  initMetadataForInterface(Deferred, 'Deferred', VOID, VOID, [Job_0], [0]);
  ...
  initMetadataForLambda(catchImpl$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  ...
  initMetadataForLambda(map$o$collect$slambda, CoroutineImpl, [CoroutineImpl], [1]);
  ...
  function CoroutineScope_0(context) {
    return new ContextScope(!(context.get_y2st91_k$(Key_getInstance_3()) == null) ? context : context.plus_s13ygv_k$(Job()));
  }
  ...
  function hasNextOnNoWaiterSuspend($this, segment, index, r, $completion) {
    ...
    try {
      ...
      if (updCellResult === get_SUSPEND()) {
        ...
        $l$block_0: {
          ...
          $l$loop_0: while (true) {
            ...
            if (updCellResult_0 === get_SUSPEND()) {
              ...
              cancellable.resume_nf5g9e_k$(true, tmp0_safe_receiver == null ? null : bindCancellationFun($this.$this_1, tmp0_safe_receiver, element));
            }
            break $l$block_0;
          }
        }
        ...
        cancellable.resume_nf5g9e_k$(true, tmp0_safe_receiver_0 == null ? null : bindCancellationFun($this.$this_1, tmp0_safe_receiver_0, element_0));
      }
    } catch ($p) {
      if ($p instanceof Error) {
        var e = $p;
  ...
  function tryResumeReceiver($this, _this__u8e3s4, element) {
    ...
    if (isInterface(_this__u8e3s4, SelectInstance)) {
      ...
      if (_this__u8e3s4 instanceof ReceiveCatching) {
        ...
        tmp = tryResume0(_this__u8e3s4.cont_1, new ChannelResult(tmp_0), tmp1_safe_receiver == null ? null : bindCancellationFunResult($this, tmp1_safe_receiver));
      } else {
  ...
  function checkContext$lambda($this_checkContext) {
    return function (count, element) {
      ...
      var collectJob = (collectElement == null ? true : isInterface(collectElement, Job_0)) ? collectElement : THROW_CCE();
      var emissionParentJob = transitiveCoroutineParent(isInterface(element, Job_0) ? element : THROW_CCE(), collectJob);
      var tmp_0;
  ...
  _.$_$.f = delay_0;
  _.$_$.g = withContext;
  _.$_$.h = withTimeoutOrNull;
  _.$_$.i = cancel$default_3;
  _.$_$.j = cancel$default_2;
  _.$_$.k = close$default;
  _.$_$.l = ChannelResult__getOrNull_impl_f5e07h;
  _.$_$.m = _ChannelResult___get_isClosed__impl__mg7kuu;
